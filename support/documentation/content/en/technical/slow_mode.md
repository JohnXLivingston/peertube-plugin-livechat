...
For an updated version of this document, you can check the [draft XEP XMP file](https://github.com/JohnXLivingston/xeps/blob/xep-slow-mode/xep-slow-mode.xml).
{{% /notice %}}
