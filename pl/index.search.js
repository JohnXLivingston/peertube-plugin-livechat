...
Peertube theme: this is a special theme, made especially for peertube’s integration. Default ConverseJS theme: this is the default ConverseJS theme. ConverseJS cyberpunk theme: this is a theme provided by ConverseJS. Automatyczne wykrywanie kolorów Try to autodetect colors from user’s current theme.
...
Port Prosody The port that will be used by the Prosody server.
...
Examples:
*, :: * 127.0.0.1, ::1 172.18.0.42 Folder certyfikatów If this field is empty, the plugin will generate and use self-signed certificates.
...
You can use «*» to listen on all IPv4 interfaces, and «::» for all IPv6.
Examples:
*, :: * 127.0.0.1, ::1 172.18.0.42 Komponenty zewnętrzne The external components to declare:
