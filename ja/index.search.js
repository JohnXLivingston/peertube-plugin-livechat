...
正規表現 警告 This feature can be disabled by the instance’s adminitrators.
By checking this option, each line of the “禁止単語または語句” field will be considered as a regular expression.
...
OBS Dock 情報 この機能は、livechatプラグイン バージョン 10.1.0にて登場します。 警告 This feature can be disabled by the instance’s adminitrators.
...
ドキュメンテーション Then open your browser on the address http://localhost:1313/peertube-plugin-livechat/. This page will automatically refresh on each modification.
...
警告 There may be links to this documentation elsewhere on the web. Try not to change the urls of the documentation pages. Or at the very least, put links to the new location on the previous url.
...
情報 この機能は、livechatプラグイン バージョン 12.0.0にて登場します。 What if I can’t use hugo and/or po4a? Just edit english markdown files, and specify that you can’t build translations when you make your Pull Request.
...
匿名ユーザーをミュート 情報 この機能は、livechatプラグイン バージョン 10.2.0にて登場します。 You can prevent anonymous users to send messages. In such case, only registered users will be able to talk in the chat.
