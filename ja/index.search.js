...
vendor The vendor folder is not part of the source code. It is used during the build process to download some external source code.`,description:"Source code organization",tags:[],title:"Source code",uri:"/peertube-plugin-livechat/ja/technical/sourcecode/index.html"},{breadcrumb:"Peertube livechat > Documentation > User documentation > For streamers > Chat bot",content:`特殊文字を禁止する 情報 This feature comes with the livechat plugin version 11.1.0.
Configuration このオプションを有効にすると、モデレーションBotは、X文字以上の特殊文字が含まれるメッセージを自動的に削除します。 特殊文字は、文字、数字、句読点記号、通貨記号、絵文字のいずれにも当てはまらないものを指します。
...
匿名ユーザーをミュート 情報 This feature comes with the livechat plugin version 10.2.0.
...
モデレーション操作を匿名か 情報 This feature comes with the livechat plugin version 11.0.0.
...
絵文字のみモード チャットルームで"絵文字のみモード"を有効にできます。 このモードが有効な時は、参加者は絵文字（標準またはチャンネル専用のカスタム絵文字）のみを送信できます。 モデレーターはこの制限の影響を受けません。
...
Create a poll You can create a new poll by using the “新規投票を作成” action in the chat top menu:
