...
モデレーターからのメッセージも対象にする デフォルトでは、モデレーターのメッセージは禁止単語・語句が含まれていても削除されません。 このオプションを有効にすると、モデレーターからのメッセージも削除されるようになります。
理由 削除理由
