...
You can also change your nickname using the chat menu.`,description:"How to chat for stream viewers",tags:[],title:"For viewers",uri:"/peertube-plugin-livechat/hr/documentation/user/viewers/index.html"},{breadcrumb:"Peertube livechat > Dokumentacija > Dokumentacija za korisnike > For streamers > Chat bot",content:`Možeš konfigurirati neke riječi koje će bot automatski moderirati (poruke koje sadrže takve riječi će se odmah izbrisati). Možeš dodati i opcionalni razlog koji će se prikazati na mjestu izbrisanih poruka. Stranica dokumentacije sadrži nekoliko primjera.
...
Također moderiraj porukama moderatora Poruke moderatora se standardno neće izbrisati ako sadrže zabranjene riječi. Označavanjem ove opcije će se poruke moderatora također izbrisati.
...
Peertube theme: this is a special theme, made especially for peertube’s integration. Default ConverseJS theme: this is the default ConverseJS theme. ConverseJS concord theme: this is a theme provided by ConverseJS. Automatsko prepoznavanje boja Try to autodetect colors from user’s current theme. When this setting is enabled, the plugin tries to auto-detect colors to apply to the chat theme. If this is not correctly working for some of your Peertube theme, you can disable this option. You can report the bug on the official issue tracker . Don’t forget to specify which theme is not working.
