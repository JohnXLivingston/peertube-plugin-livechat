...
[ { "sn": ":short_name:", "url": "https://example.com/image.png" } ] L’attribut sn est le code du nom court. L’attribut url peut être n’importe quelle url d’image à laquelle votre navigateur peut accéder, ou une URL de données représentant le fichier que vous souhaitez importer.`,description:"Emojis personnalisés du plugin peertube-plugin-livechat",tags:[],title:"Emojis personnalisés",uri:"/peertube-plugin-livechat/fr/documentation/user/streamers/emojis/index.html"},{breadcrumb:"Peertube livechat > Documentation > Documentation utilisateur⋅rice > Pour les streameur⋅euses",content:` Information Cette fonctionnalité arrive avec le plugin livechat version 12.0.0. Emojis only mode You can enable an “Emojy only mode” in your chatrooms. When this mode is enabled, participants can only send emojis (standard, or channel custom emojis). Moderators are not affected by this limitation.
