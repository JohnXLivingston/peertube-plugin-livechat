...
Si vous avez un compte Peertube sur une autre instance Peertube Information Cette fonctionnalité arrive avec le plugin livechat version 9.0.0.
Si vous avez un compte Peertube, mais pas sur l’instance courante, il y a un bouton “Se connecter avec un compte externe”. Ce bouton va ouvrir un fenêtre de dialogue où vous pourrez entrer l’URL de votre instance Peertube. Une fois celle-ci entrée, cela vérifiera sur le plugin livechat est disponible sur l’instance distante, et si la vidéo y est disponible. Dans ce cas, vous serez redirigé vers la vidéo sur l’instance distante.
...
vendor The vendor folder is not part of the source code. It is used during the build process to download some external source code.`,description:"Source code organization",tags:[],title:"Source code",uri:"/peertube-plugin-livechat/fr/technical/sourcecode/index.html"},{breadcrumb:"Peertube livechat > Documentation > Documentation utilisateur⋅rice > Pour les streameur⋅euses > Bot de tchat",content:`Forbid special characters Information This feature comes with the livechat plugin version 11.1.0.
...
Dock OBS Information Cette fonctionnalité arrive avec le plugin livechat version 10.1.0.
Avertissement Cette fonction peut être désactivée par les administrateur⋅rices de l’instance.
...
npm run doc:translateVous pouvez ensuite prévisualiser le résultat en utilisant hugo serve -s support/documentation/, et en utilisant le sélecteur de langue.
...
Avertissement Il peut y avoir des liens vers la documentation ailleurs sur le web. Essayez de ne pas changer les urls des pages de documentation. Ou au moins, mettez des liens vers les nouvelles pages dans les anciennes urls.
Que faire si je ne peux pas utiliser hugo et/ou po4a ? Il suffit d’éditer les fichiers markdown en anglais, et de spécifier que vous ne pouvez pas compiler les traductions lorsque vous faites votre Pull Request.
...
Mots interditsLe bot peut automatiquement modérer les messages contenant des mots interdits.
Messages pré-enregistrésLe bot peut envoyer des messages périodiquement.
CommandesLe bot peut répondre à différentes commandes.`,description:"Comment mettre en place le tchat pour vos diffusions en direct",tags:[],title:"Pour les streameur⋅euses",uri:"/peertube-plugin-livechat/fr/documentation/user/streamers/index.html"},{breadcrumb:"Peertube livechat > Documentation > Documentation utilisateur⋅rice > Pour les streameur⋅euses",content:` Avertissement Cette section est encore incomplète.
...
Silencier les utilisateur⋅rices anonymes Information Cette fonctionnalité arrive avec le plugin livechat version 10.2.0.
Vous pouvez empêcher les utilisateur⋅rices anonymes d’envoyer des messages. Dans ce cas, seuls les utilisateur⋅rices enregistré⋅es pourront parler dans le tchat.
...
Anonymiser les actions de modération Information Cette fonctionnalité arrive avec le plugin livechat version 11.0.0.
Il est possible d’anonymiser les actions de modération, afin d’éviter de divulguer qui bannit/expulse/… les participant⋅es.
...
Vous pouvez choisir d’activer ou de désactiver cette fonctionnalité pour les nouveaux salons de discussion sur la page de configuration de la chaîne.
Recherche dans l’historique des messages des participant⋅es Information Cette fonctionnalité arrive avec le plugin livechat version 11.0.0.
En tant qu’administrateur⋅rice ou propriétaire d’un sallon, vous pouvez rechercher tous les messages envoyés par un⋅e participant⋅e donné⋅e.
...
De là, vous pouvez également vous promouvoir en tant que modérateur⋅rice de salon en utilisant le bouton “Devenir modérateur⋅rice” sur la droite.`,description:"Fonctions de modération avancées du plugin peertube-plugin-livechat",tags:[],title:"Modération",uri:"/peertube-plugin-livechat/fr/documentation/user/streamers/moderation/index.html"},{breadcrumb:"Peertube livechat > Documentation > Documentation utilisateur⋅rice > Pour les streameur⋅euses",content:` Information Cette fonctionnalité arrive avec le plugin livechat version 10.2.0.
Configuration Vous pouvez ajouter des conditions d’utilisation à votre chaîne. Ces conditions seront affichées à tous les utilisateur⋅rices qui rejoignent le tchat.
...
Cette limitation ne s’applique pas aux modérateur⋅rices.`,description:"Mode lent du plugin peertube-plugin-livechat",tags:[],title:"Mode lent",uri:"/peertube-plugin-livechat/fr/documentation/user/streamers/slow_mode/index.html"},{breadcrumb:"Peertube livechat > Documentation > Documentation utilisateur⋅rice > Pour les streameur⋅euses",content:` Information Cette fonctionnalité arrive avec le plugin livechat version 10.3.0.
Introduction En tant que streameur⋅euse, vous pouvez choisir d’appliquer un délai aux messages dans le tchat, afin de laisser un peu de temps aux modérateur⋅rices pour supprimer des messages avant même qu’ils ne soient lus par les autres participant⋅es.
