...
You can also change your nickname using the chat menu.`,description:"How to chat for stream viewers",tags:[],title:"For viewers",uri:"/peertube-plugin-livechat/zh-hant/documentation/user/viewers/index.html"},{breadcrumb:"Peertube livechat > Documentation > User documentation > For streamers > Chat bot",content:`您可以組態一些由機器人自動審核的單字（包含此類單字的訊息將立即刪除）。 您也可以新增一個可選原因，該原因將顯示在已刪除郵件的位置。 檔案頁面上提供了幾個範例。
