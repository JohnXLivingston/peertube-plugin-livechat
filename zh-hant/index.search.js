...
不顯示遠端聊天 透過檢查此設置，您的實例將永遠不會顯示來自遠端視訊的聊天。
不公開聊天資訊 透過檢查此設置，您的實例將不會在 fediverse 上發布聊天訊息。 遠端 Peertube 實例不會意識到它們是與您的視訊關聯的聊天室。 請注意：如果您已經進行過聊天，則該資訊可能已經發布。 您必須等待下一次視訊更新，訊息才會取消發布。 此外，如果您停用此設置，則必須等待視訊更新後才能顯示資訊。 再次發布。當現場活動恢復或停止時，會發生此更新。 請注意：此設定僅影響透過 ActivityPub 協定發布資訊。 它不會阻止遠端應用程式檢測聊天的存在並嘗試連接到它。
...
顯示「共享聊天連結」按鈕 This feature enables a «share chat link» modal. With this modal, you can generate URLs to join the chat. The chat can be customized (readonly mode, use the current theme, …).
...
連接按鈕的標籤 此標籤將作為向該 OIDC 提供者進行身份驗證的按鈕標籤顯示給使用者。
...
Consider as regular expressions 警告 This feature can be disabled by the instance’s adminitrators.
By checking this option, each line of the “禁止使用的單字或句子” field will be considered as a regular expression.
...
OBS Dock 資訊 This feature comes with the livechat plugin version 10.1.0. 警告 This feature can be disabled by the instance’s adminitrators.
...
資訊 This feature comes with the livechat plugin version 12.0.0. What if I can’t use hugo and/or po4a? Just edit english markdown files, and specify that you can’t build translations when you make your Pull Request.
...
Mute anonymous users 資訊 This feature comes with the livechat plugin version 10.2.0. You can prevent anonymous users to send messages. In such case, only registered users will be able to talk in the chat.
...
Anonymize moderation actions 資訊 This feature comes with the livechat plugin version 11.0.0. It is possible to anonymize moderation actions, to avoid disclosing who is banning/kicking/… occupants.
...
You can choose to enable or disable this feature for new chatrooms on the channel configuration page.
Participant message history search 資訊 This feature comes with the livechat plugin version 11.0.0. As a room admin or owner, you can search all messages sent by a given participant.
...
From there, you can also promote yourself as room moderator by using the “成為版主” button on the right.`,description:"Plugin peertube-plugin-livechat advanced moderation features",tags:[],title:"Moderation",uri:"/peertube-plugin-livechat/zh-hant/documentation/user/streamers/moderation/index.html"},{breadcrumb:"Peertube livechat > Documentation > User documentation > For streamers",content:` 資訊 This feature comes with the livechat plugin version 10.2.0. Configuration You can add terms & conditions to your channel. These terms will be shown to all users joining the chat.
...
This limitation does not apply to moderators.`,description:"Plugin peertube-plugin-livechat slow mode",tags:[],title:"Slow mode",uri:"/peertube-plugin-livechat/zh-hant/documentation/user/streamers/slow_mode/index.html"},{breadcrumb:"Peertube livechat > Documentation > User documentation > For streamers",content:` 資訊 This feature comes with the livechat plugin version 10.3.0. Introduction As a streamer, you can choose to delay messages in the chat, to let some time to moderators to delete messages before they can even be read by other participants.
...
提示 You can combine a short moderation delay (1 second for example) with the moderation bot to delete messages containing swear words before any non-moderator user will see them.
In the chat As a moderator, you will see the remaining time (in seconds) before the message is broadcasted, just besides the message datetime.`,description:"Plugin peertube-plugin-livechat moderation delay",tags:[],title:"Moderation delay",uri:"/peertube-plugin-livechat/zh-hant/documentation/user/streamers/moderation_delay/index.html"},{breadcrumb:"Peertube livechat > Documentation > User documentation > For streamers",content:` 資訊 This feature comes with the livechat plugin version 10.1.0. Channel emojis Streamers can add custom emojis to their channels.
...
Import / Export On the channel configuration page, there are an “匯入” and an “匯出” button. The “匯出” button generates a file than you can then import on another channel.
...
[ { "sn": ":short_name:", "url": "https://example.com/image.png" } ] The sn attribute is the short name code. The url attribute can be any image url than your browser can access, or a Data URL representing the file you want to import.`,description:"Plugin peertube-plugin-livechat custom emojis",tags:[],title:"Custom emojis",uri:"/peertube-plugin-livechat/zh-hant/documentation/user/streamers/emojis/index.html"},{breadcrumb:"Peertube livechat > Documentation > User documentation > For streamers",content:` 資訊 This feature comes with the livechat plugin version 12.0.0. Emojis only mode You can enable an “Emojy only mode” in your chatrooms. When this mode is enabled, participants can only send emojis (standard, or channel custom emojis). Moderators are not affected by this limitation.
