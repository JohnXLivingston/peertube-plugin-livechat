...
Consejo You can test the livechat plugin with this demo page.
...
You can even activate the chat for specific VOD videos. This is how the demo page works: it is not a live stream, but I have activated the chat specifically for this video.`,description:"Introduction",tags:[],title:"Introduction",uri:"/peertube-plugin-livechat/es/intro/index.html"},{breadcrumb:"Peertube livechat > Contribuir",content:` Consejo Este Código de Conducta es una adaptación del Contributor Covenant, version 2.1, disponible en https://www.contributor-covenant.org/version/2/1/code_of_conduct.html. Las traducciones están a disposición en https://www.contributor-covenant.org/translations. Los casos de comportamiento abusivo, acosador o inaceptable se pueden informar a los líderes de la comunidad responsables de la aplicación por correo en git.[at].john-livingston.fr.
...
For answers to common questions about this code of conduct, see the FAQ at https://www.contributor-covenant.org/faq. Translations are available at https://www.contributor-covenant.org/translations.`,description:"Código de Conducta para contribuyentes",tags:[],title:"Código de Conducta",uri:"/peertube-plugin-livechat/es/contributing/codeofconduct/index.html"},{breadcrumb:"Peertube livechat",content:` User documentationPlugin peertube-plugin-livechat user documentation
...
Using MatterbridgeUsing Matterbridge to bridge with other chats`,description:"Plugin documentation",tags:[],title:"Documentación",uri:"/peertube-plugin-livechat/es/documentation/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation",content:`Joining chat rooms When you are watching a Peertube video that has the chat activated, you will see the chat next to the video:
...
If you haven’t a Peertube account Aviso This feature can be disabled by the instance’s adminitrators.
...
Log in using an external authentication provider Aviso This feature can be disabled by the instance’s adminitrators.
The Peertube instance can configure external authentication providers (Mastodon accounts, Google accounts, …). In such case, you will see a “Iniciar sesión usando una cuenta externa” button, that will open a dialog modal. In this dialog modal, there will be some buttons to connect using a remote account.
...
You can also change your nickname using the chat menu.`,description:"How to chat for stream viewers",tags:[],title:"For viewers",uri:"/peertube-plugin-livechat/es/documentation/user/viewers/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers > Chat bot",content:`Puedes configurar algunas palabras que serán moderadas automáticamente por el bot (los mensajes que contengan dichas palabras serán borrados instantáneamente). También puedes añadir una razón opcional que se mostrará en el lugar de los mensajes eliminados. Se proporcionan varios ejemplos en la página de documentación. You can fill several “Palabras o expresiones prohibidas” fields. When a user sends a message that match the configured criteria, the message will automatically be deleted.
Palabras o expresiones prohibidas In this field, you can set several words, group of words, or “regular expressions”.
Una palabra o expresión por línea. Si pones varias palabras en una línea, solo coincidirá con los mensajes que contengan la secuencia completa. Each time a user sends a message, these words will be tested. If the message containes one of them, the message will be deleted.
...
Moderar también los mensajes de los moderadores Por defecto, los mensajes de los moderadores no se borrarán cuando contengan palabras prohibidas. Al marcar esta opción, los mensajes de los moderadores también se eliminarán. Motivo Motivo para mostrar además de eliminar los mensajes Comentarios Puedes añadir aquí algunos comentarios sobre esta regla, para recordar cómo y por qué la creaste. Estos comentarios son puramente indicativos, y no influyen en el comportamiento del bot. `,description:"The bot can automatically moderate messages containing forbidden words.",tags:[],title:"Forbidden words",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/bot/forbidden_words/index.html"},{breadcrumb:"Peertube livechat > Documentación > Admin documentation",content:`This section describes the plugin settings page.
Channel's chat terms & conditions You can configure a "terms & conditions" message that will be shown to users joining your chatrooms. For more information on this feature, check the documentation for channel’s terms & conditions.
Información Changing this setting will restart the chat server, and all users will be disconnected for a short time.
Listar salas existentes When pressing the «List rooms» button, all existing chatrooms will be listed. You can then find them and moderated them.
Federation Following settings concern the federation with other Peertube instances, and other fediverse softwares.
No mostrar chats remotos Marcando este ajuste, su instancia nunca mostrará los chats de los vídeos remotos. No publicar información del chat Al aceptar esta configuración, su instancia no publicara la información del chat en el fediverse. Instancias remotas de Peertube no estaran al tanto de la existencia de chat rooms liados a sus videos. Porfavor note: si ya tiene chats en progreso, es posible que la información ya haya sido publicada. Tendra que esperar a la próxima actualización del video antes de que la información sea ocultada. Ademas, si desactiva esta configuracion, tendra que esperar a la próxima actualización del video antesde que la información sea publicada otra vez. Esta actualización sucede, ente otros, cuando un evento en vivo reanuda o se detiene.
Porfavor note: esta configuración solo afecta la publicación de información via el protocolo ActivityPub. Ella no prevendra une applicación remota de detectar la presencia de chats y de intentar connectarse a ellos. Authentication Disable livechat tokens In case you have any trouble with the long term authentication tokens, you can disable the feature here.
...
Chat behaviour Tipo de sala Puede elegir tener distintas salas para cada video, o agruparlas por canal. Abrir el chat automaticamente Cuando se reproduzca un vídeo, el chatbox se abrirá automáticamente. Muestra el botón «abrir en ventana nueva» Habrá un botón para abrir el web chat en una nueva ventana. Muestra el botón "enlace para compartir el chat" This feature enables a «share chat link» modal. With this modal, you can generate URLs to join the chat. The chat can be customized (readonly mode, use the current theme, …).
...
Los usuarios pueden activar el chat para sus directos Si se marca, todos los vídeos en directo tendrán un checkbox en sus propiedades para activar el web chat. The video owner will be able to activate web chats.
Activar chat para todos los en vivos Si se marca, el chat sera activado para todos los en vivos. Activar chatpara todos los no - en vivos Activar chatpara todos los no - en vivos Activar chat para estos vídeos Activar chat para estos vídeos Esconder chat para usuarios anónimos Si se marca, los usuarios anónimos de Peertube no verán el chat. Funcionalidad en desarrollo. Si la activas, es muy recomendable marcar también "No publicar información del chat". De lo contrario, algunas herramientas de terceros podrían intentar abrir el chat , generando comportamientos imprevistos. Note: for now this feature simply hide the chat. In a future release, the chat will be replaced by a message saying «please log in to […]». See v5.7.0 Release Notes for more information.
Banear la IP del usuario si le banean de una sala de chat Al habilitar esta opción, cada vez que un usuario anónimo sea excluido de una sala de chat, su IP también será baneada del servidor de chat. Advertencia: si su instancia está abierta a la inscripción, cualquier usuario podría crear un chat de trampa, invitar a los usuarios a unirse y banear automáticamente todas las IP de esos usuarios anónimos. La lista de IP baneadas no se almacena, se borrará al reiniciar el servidor o cuando cambie la configuración de algún plugin. Las IP baneadas se guardan en los archivos de registro del servidor Prosody, por lo que los administradores del servidor pueden eventualmente usar algunas herramientas externas (como fail2ban) para bloquear el acceso las IP de manera más amplia. Important note: If you enable this feature, and are using a custom reverse proxy on front of Peertube, please make sure that your setup is correctly configured to forward real user’s IPs to Peertube. Otherwise it could block all anonymous users at once.
Theming Conjunto de avatares You can choose from several different sets the default avatars that will be used for chat users.
...
ConverseJS tematización You can choose which theme to use for ConverseJS:
Peertube theme: this is a special theme, made especially for peertube’s integration. Default ConverseJS theme: this is the default ConverseJS theme. ConverseJS concord theme: this is a theme provided by ConverseJS. Detección de color automatica Intenta detectar automáticamente los colores del tema actual del usuario.
Cuando está habilitado, el plugin intenta detectar automáticamente los colores para aplicarlos al tema del chat.
Si no funciona correctamente para algunos de sus temas de Peertube, puede deshabilitar esta opción. Puede informar de un error en el rastreador de problemas . No olvide especificar qué tema no funciona. Atributo de estilo iframe del Webchat Se agregarán estilos adicionales en el atributo de estilo iframe. Por ejemplo: height:400px; Chat server advanced settings Use el sistema Prosody The plugin comes with an AppImage that is used to run the Prosody XMPP server. If this AppImage is not working, you can fallback to the Prosody that is packaged for your server. Just install the prosody package.
This setting should only be used if the plugin is broken, and waiting for a patch.
Desactivar Websocket Con Peertube >= 5.0.0, este plugin intenta usar una conexión Websocket para chatear. Si el navegador o la conexión del usuario son incompatibles, el navegador recurrirá automáticamente al protocolo BOSH. En ciertos casos esto puede fallar. Por ejemplo, si tiene un proxy inverso frente a Peertube que no permite una conexión Websocket para plugins. En tal caso, puede marcar este parámetro para deshabilitar las conexiones Websocket. Prosody puerto El puerto que sera usado por el servidor Prosody.
...
Nota: esto podría cambiar en un futuro cercano, ya que está previsto agregar una función para activar las conexiones externas. URL de Peertube para peticiones de API Por favor, deje esta configuración vacía si no sabe lo que está haciendo.
En algunos casos raros, Prosody no puede llamar a la API de Peertube desde su URI pública. Puede usar este campo para personalizar el URI de Peertube para los módulos de Prosody (por ejemplo, con "http://localhost:9000" o "http://127.0.0.1:9000"). If this setting is left empty, and you are using Peertube >= 5.1 or later, the plugin will use values from your Peertube configuration file to guess on which interface and port request have to be done.
...
Contenido de los logs de las salas por defecto Si está marcado, el contenido de la sala de chat se guardará de forma predeterminada. Cualquier usuario que se una a una sala verá lo que se escribió antes de unirse.
Tenga en cuenta que siempre es posible habilitar/deshabilitar el contenido salvaguardado de una sala específica, editando sus propiedades. Caducidad del historial de la sala Aquí puede elegir cuánto tiempo el servidor conserva el contenido de la sala de chat. El valor puede ser: 60: el contenido se guardará durante 60 segundos. Puede reemplazar 60 por cualquier valor entero. 1d: el contenido se guardará durante 1 día. Puede reemplazar 1 por cualquier valor entero. 1s: el contenido se guardará durante 1 semana. Puede reemplazar 1 por cualquier valor entero. 1m: el contenido se guardará durante 1 mes. Puede reemplazar 1 por cualquier valor entero. 1y: el contenido se guardará durante 1 año. Puede reemplazar 1 por cualquier valor entero. nunca: el contenido nunca caducará y se mantendrá para siempre. Activar conexión a la sala con cuentas XMPP externas Al habilitar esta opción, será posible conectarse a salas utilizando cuentas XMPP externas y clientes XMPP.
Advertencia, habilitar esta opción puede solicitar un servidor adicional y una configuración de DNS. Por favor, consulte la documentación: Habilitar conexiones con cuentas XMPP externas. Puerto Prosody de servidor a servidor El puerto que se usará para las conexiones XMPP s2s (servidor a servidor).
Debe utilizar el puerto estándar 5269. De lo contrario, debería configurar un registro DNS específico . Interfaces de red de servidor a servidor Las interfaces de red para escuchar conexiones de servidor a servidor.
...
Ejemplos: *, :: * 127.0.0.1, ::1 172.18.0.42 Directorio de certificados Si este campo está vacío, el plugin generará y utilizará certificados autofirmados.
Si desea utilizar otros certificados, sólo tiene que especificar aquí el directorio donde Prosody puede encontrarlos. Nota: el usuario "peertube" debe tener acceso de lectura a este directorio. Activar las conexiones cliente-servidor Habilitar clientes XMPP para conectarse al servidor Prosody integrado.
Esta opción sólo permite conexiones desde clientes en localhost. This setting enable XMPP clients to connect to the built-in Prosody server. For now, this option only allows connections from localhost clients.
As example, this option can allow an instance of Matterbridge (once it could use anonymous login) on the same machine to bridge your chat with another services like a Matrix room.
Puerto de cliente a servidor Prosody El puerto que utilizará el módulo c2s del servidor Prosody integrado.
...
Nota: esto podría cambiar en un futuro cercano, ya que está previsto agregar una función para activar las conexiones externas. Client to server network interfaces The network interfaces to listen on for client to server connections.
...
Examples: *, :: * 127.0.0.1, ::1 127.0.0.1, ::1, 172.18.0.42 Habilitar componentes externos personalizados de Prosody This setting enable XMPP external components to connect to the server. By default, this option only allows connections from localhost components. You have to change the “Interfaces de red de componentes externos de Prosody” value to listen on other network interfaces.
This feature could be used to connect bridges or bots.
More informations on Prosody external components here.
Habilitar componentes externos personalizados de Prosody Activar el uso de componentes XMPP externos.
...
Esta función se puede utilizar, por ejemplo, para conectar algunos bots a las salas de chat. Puerto de componentes externos Prosody El puerto que usarán los componentes XMPP para conectarse al servidor Prosody.
Cámbielo si este puerto ya está en uso en su servidor.
Puede mantener este puerto cerrado con su firewall por ahora, no se accederá desde el mundo exterior. Interfaces de red de componentes externos de Prosody Las interfaces de red para escuchar las conexiones de componentes externos.
Lista de IP para escuchar, separadas por coma (se eliminarán los espacios).
Puede utilizar «*» para escuchar en todas las interfaces IPv4 y «::» para todas las IPv6.
Ejemplos: *, :: * 127.0.0.1, ::1 172.18.0.42 Componentes externos Los componentes externos a declarar: Uno por línea. Utilice el formato «component_name:component_secret» (los espacios se recortarán). Puede agregar comentarios: todo lo que esté después del carácter # se eliminará y las líneas vacías se ignorarán. El nombre solo puede contener caracteres alfanuméricos latinos y puntos. Si el nombre contiene solo caracteres alfanuméricos, tendrá como sufijo el dominio XMPP. Por ejemplo, «bridge» se convertirá en «bridge.tu_dominio.tld». También puede especificar un nombre de dominio completo, pero debe asegurarse de configurar su DNS correctamente. Use solo caracteres alfanuméricos en la frase de contraseña secreta (use al menos 15 caracteres). Enable Prosody mod_firewall You can enable mod_firewall on your Prosody server.
For more information, please check the documentation.`,description:"Plugin Peertube Livechat settings",tags:[],title:"Settings",uri:"/peertube-plugin-livechat/es/documentation/admin/settings/index.html"},{breadcrumb:"Peertube livechat > Technical documentation",content:`This page describes the different source code folders and their content.
...
vendor The vendor folder is not part of the source code. It is used during the build process to download some external source code.`,description:"Source code organization",tags:[],title:"Source code",uri:"/peertube-plugin-livechat/es/technical/sourcecode/index.html"},{breadcrumb:"Peertube livechat > Documentación > Installation guide",content:`I just installed/upgraded the plugin, but nothing happens If you have just installed/upgraded the plugin, but nothing happens (no chat, no settings, buttons in the settings page does not work, …), just try to reload the page.
...
In such case, try changing the “URL de Peertube para peticiones de API” settings, by setting http://127.0.0.1:9000 (assuming 9000 is the port on which Peertube listen, ask your instance administrators if you don’t know).
...
If you can’t fix this immediatly, you can disable Websocket by unchecking “Desactivar Websocket” in the plugin setting page. In such case, you should also check “No publicar información del chat”, as chat federation won’t work without Websocket.`,description:"Some classic mistakes and workarounds.",tags:[],title:"Troubleshooting",uri:"/peertube-plugin-livechat/es/documentation/installation/troubleshooting/index.html"},{breadcrumb:"Peertube livechat > Documentación",content:` For viewersHow to chat for stream viewers
OBSDocumentation to stream the chat content using OBS.
XMPP ClientsConnect to chat using a XMPP client
For streamersHow to setup the chat for your live stream
Some basicsSome basics about how to setup and use the chat for your live stream
...
OpenID Connect Aviso This feature is still experimental. This feature is available with the plugin version >= 9.0.0.
...
More to come Other authentication methods will be implemented in the future.`,description:"Plugin Peertube Livechat settings - External Authentication",tags:[],title:"External Authentication",uri:"/peertube-plugin-livechat/es/documentation/admin/external_auth/index.html"},{breadcrumb:"Peertube livechat > Documentación",content:` Información Before updating to a major release, please read the release notes and breaking changes list : CHANGELOG.
Consejo To install or update the plugin, just use the Peertube web admin interface.
Here are some other more specific instructions:
TroubleshootingSome classic mistakes and workarounds.
Known issues: CPU CompatibilityFor now, the plugin only works out of the box for x86_64 and arm64 CPU architecture. Here are some instructions for other CPU architectures.
Upgrade from version older than 6.0.0Important notes when upgrading for an older version.`,description:"Plugin peertube-plugin-livechat installation guide",tags:[],title:"Installation guide",uri:"/peertube-plugin-livechat/es/documentation/installation/index.html"},{breadcrumb:"Peertube livechat > Documentación > Installation guide",content:`The Prosody AppImage included in the plugin will only work on x86_64 and arm64 CPU. It is not compatible with other CPU architectures.
...
opening a web page (with an url like https://yourinstance.tld/plugins/livechat/router/webchat/room/8df24108-6e70-4fc8-b1cc-f2db7fcdd535), using a XMPP client (and joining a room like xmpp://8df24108-6e70-4fc8-b1cc-f2db7fcdd535@room.yourinstance.tld?join) Aviso Joining the chat using a XMPP client is not always possible. It requires some DNS and server configuration. It will only be possible if instance’s admins have correctly setup the external XMPP clients connection feature.
Aviso Don’t try to gues these url and connection methods yourself. Please report to next chapters.
...
Información This requires Peertube >= 5.1
This follows the FEP-1970 recommendations.
Aviso At the time of the writing, this FEP is in draft status, and the livechat plugin is a Proof-of-concept. Until the FEP is adopted, the specification can change, and the livechat plugin will be adapted accordingly.
...
Información This requires Peertube >= 5.2
Información The <podcast:chat> element is currently only supported for live streams.
This follows the <podcast:chat> proposal.
Aviso At the time of the writing, this proposal is in draft status, and the livechat plugin is a Proof-of-concept. Until the proposal is adopted, the specification can change, and the livechat plugin will be adapted accordingly.
...
get the Podcast RSS feed for the channel, if there is no <podcast:liveItem> element under the <channel>, stop. find the <podcast:liveItem> you are looking for <podcast:socialInteract> can be used to cross-reference the items with ActivityPub loop through the <podcast:chat> values (if <podcast:chat> is not an array, just iterate on this single value) there should only be one, but you should expect to handle several just in case search for the first entry protocol === xmpp and a space attribute space should be an XMPP JID for a MUC if found, open this XMPP JID with your client after converting it to a join URI, or connect to the XMPP room at that address `,description:"Displaying the livechat with 3rd party software.",tags:[],title:"Third party",uri:"/peertube-plugin-livechat/es/technical/thirdparty/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers > Chat bot",content:`Puedes configurar varios temporizadores que enviaran mensajes cada cierto intervalo. Estos mensages los enviara el bot cada X minutos. Puedes por ejemplo hacer que el bot muestre información de tus patrocinadores cada 5 minutos. Consejo If there is no user in the chatroom, the bot won’t send any message.
Temporizador Puedes configurar varios temporizadores que enviaran mensajes cada cierto intervalo. Estos mensages los enviara el bot cada X minutos. Puedes por ejemplo hacer que el bot muestre información de tus patrocinadores cada 5 minutos. Un mensaje por línea. Si hay varios mensajes, se seleccionará uno al azar cada X minutos. Enviar cada X minutos El bot publicará el mensaje cada X minutos. `,description:"The bot can send periodically some messages.",tags:[],title:"Timers",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/bot/quotes/index.html"},{breadcrumb:"Peertube livechat > Contribuir",content:`Puedes contribuir a la traducción de este plugin. Las traducciones se realizan con el software Weblate, utilizando la instancia Weblate de Framasoft .
Aviso Nunca modifiques directamente los archivos del directorio languages, esto podría provocar conflictos.
Cómo Crea una cuenta en: https://weblate.framasoft.org/accounts/register/ Valida tu email y sigue el enlace enviado Crea tu contraseña y configura tu cuenta Dirigete a la página del proyecto del plugin: https://weblate.framasoft.org/projects/peertube-livechat/peertube-plugin-livechat/ Selecciona la configuración regional que deseas traducir Sólo tienes que traducir las frases que faltan o corregir las que te parezcan incorrectas. Aviso Puede haber algunas cadenas “muy técnicas”. Si no estás al 100% seguro del significado, o de su traducción, es mejor que no las traduzcas, y que se muestren en inglés.
Traducciones de ConverseJS Este plugin se basa en ConverseJS para el front-end del chat. ConverseJS genera sus propias traducciones, en su instancia weblate. También puedes traducir directamente en el repositorio de código. Para más información, consulta la documentación sobre las traducciones de ConverseJS.
Agregar una nueva configuración regional Si crees que falta una configuración regional, verifica primero si se toma en cuenta en Peertube. Si es así, puedes abrir un issue para solicitarla.
...
Generic recommandations Please be inclusive in your wordings, and please respect the code of coduct.`,description:"Traducir el plugin",tags:[],title:"Traducir",uri:"/peertube-plugin-livechat/es/contributing/translate/index.html"},{breadcrumb:"Peertube livechat > Documentación",content:` SettingsPlugin Peertube Livechat settings
External AuthenticationPlugin Peertube Livechat settings - External Authentication
Prosody mod_firewallAdvanced firewall rules for the Prosody server
Advanced usageSome advanced features
XMPP clientsAllow connections using XMPP clients
Using MatterbridgeUsing Matterbridge to bridge with other chats`,description:"Plugin Peertube Livechat administration",tags:[],title:"Admin documentation",uri:"/peertube-plugin-livechat/es/documentation/admin/index.html"},{breadcrumb:"Peertube livechat > Contribuir",content:"No necesitas saber programar para empezar a contribuir al desarrollo de este plugin. Otras contribuciones son igualmente muy valiosas, tales como: probar el software y reportar bugs, dar feedback, comentar sobre características que te interesen o sobre la interfaz de usuario, el diseño, …",description:"Envianos tu feedback",tags:[],title:"Envianos tu feedback",uri:"/peertube-plugin-livechat/es/contributing/feedback/index.html"},{breadcrumb:"Peertube livechat > Documentación > Admin documentation",content:` Información This feature comes with the livechat plugin version 11.0.0.
You can enable mod_firewall on your Prosody server.
Doing so, Peertube admins will be able to define advanced firewall rules.
Aviso These rules could be used to run arbitrary code on the server. If you are a hosting provider, and you don’t want to allow Peertube admins to write such rules, you can disable the online editing by creating a disable_mod_firewall_editing file in the plugin directory (plugins/data/peertube-plugin-livechat/disable_mod_firewall_editing). This is opt-out, as Peertube admins can already run arbitrary code just by installing any plugin. You can still use mod_firewall by editing files directly on the server.
...
Examples Don’t hesitate to share your rules. To do so, you can for example edit this page.`,description:"Advanced firewall rules for the Prosody server",tags:[],title:"Prosody mod_firewall",uri:"/peertube-plugin-livechat/es/documentation/admin/mod_firewall/index.html"},{breadcrumb:"Peertube livechat > Documentación > Admin documentation > Advanced usage",content:`This chat module is based on the XMPP protocol, also known as Jabber. It is therefore possible to connect to the chats using XMPP client software. This can for example be useful to facilitate moderation operations.
For the user documentation associated with these features, please refer to the user documentation page.
Información Enabling these features requires configuration changes on the server, and on the DNS records. It is not possible to configure this only from the Peertube interface, and it requires some basic system some basic system admin skills.
Login to your Peertube account Aviso This feature is not yet available, and will come in a future version of the plugin.
...
docker-compose exec -u peertube \\ peertube \\ /data/plugins/data/peertube-plugin-livechat/prosodyAppImage/squashfs-root/AppRun \\ prosodyctl \\ --config /data/plugins/data/peertube-plugin-livechat/prosody/prosody.cfg.lua \\ check certsTroubleshooting If you can’t make it work, you can use the diagnostic tool (there is a button on top of the plugin settings page), and take a close look on the «Prosody check» section.`,description:"Allow connections using XMPP clients",tags:[],title:"XMPP clients",uri:"/peertube-plugin-livechat/es/documentation/admin/advanced/xmpp_clients/index.html"},{breadcrumb:"Peertube livechat > Documentación > Admin documentation",content:` XMPP clientsAllow connections using XMPP clients
Using MatterbridgeUsing Matterbridge to bridge with other chats`,description:"Some advanced features",tags:[],title:"Advanced usage",uri:"/peertube-plugin-livechat/es/documentation/admin/advanced/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers > Chat bot",content:`Puedes configurar el bot para que responda a comandos. Un comando es un mensaje que comienza con "!", como por ejemplo "!help" que llama al comando "help". You can setup several commands.
Comando El comando, sin el "!" inicial. Por ejemplo "ayuda", "patrocinador",... Enviar cada X minutos El bot publicará el mensaje cada X minutos. `,description:"The bot can respond to several commands.",tags:[],title:"Commands",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/bot/commands/index.html"},{breadcrumb:"Peertube livechat > Contribuir",content:`Hable siempre sobre las características que desea desarrollar al crear/encontrar y comentar la cuestión que aborda su problema antes de empezar a trabajar en él, e informe a la comunidad que comienza a codificar reclamando el problema.
Un Pull Request se debe solicitar en la rama main.
Nota Hasta marzo de 2023, las contribuciones se hacían en la rama develop. Esto ya es obsoleto.
Requisito previo para construir este plugin Es muy recomendable el familiarizarse con los siguientes conceptos:
Git NodeJS NPM TypeScript Para generar el plugin, debe tener los siguientes paquetes:
git npm (>=8.x) nodejs (>=14.x) build-essential coreutils wget reuse Tenga en cuenta que este plugin necesita una AppImage para el servidor Prosody XMPP. Esa AppImage la proporciona el proyecto paralelo Prosody AppImage. El script build-prosody.sh descarga los binarios adjuntos de ese repositorio remoto y verifica que sus checksum sha256 sean correctos.
Desarrollar Clona el repositorio, genera el plugin y crea tu rama de características:
# Clona el repositorio. No olvides el --recursive para clonar submódulos. git clone https://github.com/JohnXLivingston/peertube-plugin-livechat.git --recursive cd peertube-plugin-livechat # Instala las dependencias de NPM y construye el módulo por primera vez: npm install # Construir el plugin después de una modificación: npm run build # Si tienes un fork del repositorio, añádelo como remoto (ejemplo): git remote add me git@github.com:MY_GITHUB_ACCOUNT/peertube-plugin-livechat.git # Crea una rama local para tus desarrollos, haz checkout para ello (ejemplo): git checkout mi_desarrollo # Nota: si hay una incidencia asociada, usa fix_1234 como nombre de tu rama (donde 1234 es el número de la incidencia) # Para enviar tus modificaciones, haz un push de tu rama a tu repositorio (ejemplo): git push --set-upstream me mi_desarrollo # Dirijete a tu repositorio github con tu navegador web para abrir una solicitud de incorporación de cambios Pull Request (ver instrucciones adicionales más abajo)Una vez que esté listo para mostrar su código y desea solicitar comentarios, envíe un borrador de solicitud de incorporación de cambios. Una vez que esté listo para una revisión de código antes de la fusión, envíe una solicitud de incorporación de cambios. En cualquier caso, vincule su PR a los problemas que resuelve utilizando la sintaxis de GitHub: “fixes #issue_number”.
...
Aviso No habilites este modo en un servidor de producción, ni en un servidor público. Esto podría ocasionar problemas de seguridad.
Reiniciar Prosody Cuando el modo de depuración está activado, puede reiniciar Prosody utilizando esta llamada a la API: http://your_instance.tld/plugins/livechat/router/api/restart_prosody. Esta llamada no necesita autenticación. La puede hacer desde la linea de comandos, usando por ejemplo curl http://your_instance.tld/plugins/livechat/router/api/restart_prosody.
Depurador de Prosody Es posible conectar la AppImage Prosody a un depurador remoto usando [MobDebug]https://luarocks.org/modules/paulclinger/mobdebug).
...
{ "debug_prosody": { "debugger_path": "/the_path_to_mobdebug/src", "host": "localhost", "port": "8172" } }host y port son opcionales. debugger_path debe apuntar a la carpeta donde se encuentra el archivo MobDebug .lua.
Reiniciar Peertube.
...
Entorno de desarrollo rápido con Docker Hay un tutorial, en francés, en el foro de Peertube que explica cómo construir rápidamente un entorno de desarrollo utilizando Docker.
...
Reconstruir e instalar rápidamente el plugin Cuando hace un cambio, no debe siempre reconstruir el proyecto completo, y reinstalar el plugin en su entorno de desarrollo. Puede solo construir la parte modificada( ejemplo, si solo has modificado los ficheros del cliente: npm run build:client). Verifica el fichero package.json para los scripts de construcción disponibles.
...
reconstruir las partes necesarias del plugin, (cliente, estilos, …), sobrescribir el contenido de data/plugins/node_modules/peertube-plugin-livechat/dist/ de su instancia de desarrollo con el contenido del directorio dist, change recursively plugins/node_modules/peertube-plugin-livechat/dist/ files owner to your peertube user, restart your instance. Pruebas de rendimiento El repositorio livechat-perf-test contiene algunas herramientas para realizar pruebas de rendimiento. Se puede utilizar para evaluar mejoras de código, o encontrar cuellos de botella.`,description:"Desarrollar",tags:[],title:"Desarrollar",uri:"/peertube-plugin-livechat/es/contributing/develop/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation",content:`OBS is a popular Free And Open Source streaming software, with advanced capacities for your live streams. In the current page, you will find some advices to handle your live chats using OBS.
OBS Overlay You can easily include the chat in your video stream.
You can use the “Compartir el enlace de esta sala de chat” feature to generate an URL to your chat. This button should be near the chat if you are the video owner (unless it was desactivated by your server admins).
Check the “Sólo lectura” checkbox in the modal.
Then use this link as a “web browser source” in OBS.
You can use the “Fondo transparente (para la integración en directos, por ejemplo con OBS)” option to have a transparent background in OBS. If you want to customize the background transparency, you can add this CSS in your OBS browser source’s settings:
...
OBS Dock Información This feature comes with the livechat plugin version 10.1.0.
Aviso This feature can be disabled by the instance’s adminitrators.
...
To do so, just use the “Compartir el enlace de esta sala de chat” feature, and open the “Dock” tab. From there, you can create a new token using the “+” button.
...
Consejo Tokens are valid to join any chat room. You don’t have to generate separate tokens for each of your rooms. You can also customize the nickame that will be used by changing the n parameter in the url.
...
Información These tokens can be used for other purposes, as connecting to your account with XMPP bots or clients. This feature is not documented yet, and not officially supported. So use with care.
Mixing multiple chats in your live stream You can use the social_stream browser extension to mix multiple chat source (from Peertube, Twitch, Youtube, Facebook, …) and include their contents in your live stream. The compatibility with this plugin was added in recent versions.`,description:"Documentation to stream the chat content using OBS.",tags:[],title:"OBS",uri:"/peertube-plugin-livechat/es/documentation/user/obs/index.html"},{breadcrumb:"Peertube livechat > Contribuir",content:`Información general Siempre informa a la comunidad antes de trabajar (creando un nuevo ‘issue’ o comentando uno existente). Esto es para evitar que dos personas estén trabajando en lo mismo y prevenir conflictos.
...
Traducciones El idioma principal es el inglés (código en).
...
Internal connections only (basic) You will need to enable Activar las conexiones cliente-servidor in the livechat plugin settings.
...
Información This documentation use an anonymous account to connect the bridge to the chat. But since the livechat v10.1.0, there is a new way to generate long term authentication token, that allows to connect using your account. This is used for OBS docks. Using this feature for other purposes is not documented and not officially supported yet. If you want to use it anyway, you can request a token by calling then /plugins/livechat/router/api/auth/tokens endpoint. To get needed headers and request body, just check what happens when you generate a new token for OBS docks.`,description:"Using Matterbridge to bridge with other chats",tags:[],title:"Using Matterbridge",uri:"/peertube-plugin-livechat/es/documentation/admin/advanced/matterbridge/index.html"},{breadcrumb:"Peertube livechat",content:`¿Interesado en contribuir? ¡Estupendo!
Código de ConductaCódigo de Conducta para contribuyentes
TraducirTraducir el plugin
Envianos tu feedbackEnvianos tu feedback
DesarrollarDesarrollar
DocumentaciónDocument the plugin, or translate the documentation.`,description:"Contribuir",tags:[],title:"Contribuir",uri:"/peertube-plugin-livechat/es/contributing/index.html"},{breadcrumb:"Peertube livechat > Technical documentation",content:`The livechat plugin includes a “slow mode” feature, to rate limit the number of messages that a user can send to a given MUC room. At time of writing, there were no XEP to describe such feature. Please find below a XEP draft, that will be submitted for review.
Aviso Work In Progress, this page is not done yet. For an updated version of this document, you can check the draft XEP XMP file.
...
Appendix F: Requirements Conformance The following requirements keywords as used in this document are to be interpreted as described in RFC 2119: “MUST”, “SHALL”, “REQUIRED”; “MUST NOT”, “SHALL NOT”; “SHOULD”, “RECOMMENDED”; “SHOULD NOT”, “NOT RECOMMENDED”; “MAY”, “OPTIONAL”.`,description:"MUC Slow mode XEP",tags:[],title:"MUC Slow mode",uri:"/peertube-plugin-livechat/es/technical/slow_mode/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation",content:`This chat plugin relies on the XMPP protocol (also known as Jabber). It is therefore possible to connect to the chats using XMPP client software. This can be useful for example to facilitate moderation operations.
Información The features described on this page must be enabled and configured by your Peertube instance’s administrators. You may therefore not have access to them.
Login to your Peertube account Aviso This feature is not yet available, and will come in a future version of the plugin.
...
Información By default, the share button is only visible to the owner of the video, and the admins/moderators of the instance. However, admins can decide to display this button for everyone.
Then, choose “Connect using XMPP”:
Then you just have to click on “open” or copy/paste the address of the chat room into your XMPP client (using the “join a room” feature).`,description:"Connect to chat using a XMPP client",tags:[],title:"XMPP Clients",uri:"/peertube-plugin-livechat/es/documentation/user/xmpp_clients/index.html"},{breadcrumb:"Peertube livechat > Technical documentation",content:`The poll system relies on two thinks:
...
Moderator notes overviewModerator Notes Application technical overview`,description:"Technical documentation",tags:[],title:"Technical documentation",uri:"/peertube-plugin-livechat/es/technical/index.html"},{breadcrumb:"Peertube livechat",content:`Si tiene alguna pregunta o si desea hablar sobre este plugin, puede unirse a esta sala XMPP con cualquier cliente Jabber.: plugin-livechat-support@room.im.yiny.org.
Si quieres apoyar financieramente el proyecto, puedes contactarme por correo electrónico en git.[at].john-livingston.fr, or check my Liberapay profile.`,description:"Contacta con el autor",tags:[],title:"Contáctame",uri:"/peertube-plugin-livechat/es/contact/index.html"},{breadcrumb:"Peertube livechat",content:`package.json, COPYRIGHT and LICENSE files contain the license information for this software and its dependencies.
...
And thanks to all individual contributors who have made a donation via my liberapay page.`,description:"Plugin Credits",tags:[],title:"Credits",uri:"/peertube-plugin-livechat/es/credits/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:`Enabling the chat for you live streams Aviso Instance administrators can choose to disable or enable chat in specific cases. Information in this section are only true in the default case.
When you create or modify a Peertube live, there is a “plugin settings” tab:
In the “plugin settings” tab, there is a “Habilitar el chat” checkbox. Just check or uncheck it to enable or disable the chat associated to your video.
Consejo There can be other settings in this tab, depending on plugins installed on your Peertube instance.
...
Share the chat On top of the chat, there is a “Compartir el enlace de esta sala de chat” button.
...
Sólo lectura: you will only be able to read the chat, not write. This is useful to include the chat content in your live stream (see the OBS documentation). Utilizar los colores del tema actual: if checked, your current theme colors will be added to the url, so that any user that opens the link will have the same color set. Generar un iframe para incrustar el chat en un sitio web: instead of an url, you will obtain an HTML snippet that you can add to your website to embed the chat. For more information on the “Dock” tab, check the OBS documentation.
...
The “Compartir el enlace de esta sala de chat” popup can also contain a “Conectar utilizando XMPP” tab. This will only be available if your instance’s administators have enabled an correctly configured this option. Using this option, you can provide a link to join the chat using any XMPP client software. Using such softwares can for example facilitate moderation actions.
...
The chat will be automatically recreated each time someone tries to join it as long as the video exists, and has the “Habilitar el chat” feature activated.`,description:"Some basics about how to setup and use the chat for your live stream",tags:[],title:"Some basics",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/basics/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 8.0.0, and can be disabled by your instance’s admins.
In the Peertube left menu, there is a “Salas de chat” entry:
This “Salas de chat” link takes you to a list of your channels. By clicking on a channel, you will then be able to setup some options for your channels:
Here you can configure:
Channel's chat terms & conditions Mute anonymous users default value The slow mode The chat bot Custom emojis More features to come… `,description:"Peertube channel chatrooms configuration",tags:[],title:"Channel configuration",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/channel/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation",content:` Some basicsSome basics about how to setup and use the chat for your live stream
Channel configurationPeertube channel chatrooms configuration
ModerationPlugin peertube-plugin-livechat advanced moderation features
Terms & conditionsConfigure channel's chat terms & conditions
Slow modePlugin peertube-plugin-livechat slow mode
...
Aviso This page describes the behaviour of livechat versions >= 10.0.0. There were some changes in the way we manage access rights for Peertube administrators and moderators.
...
Consejo The video owner will be owner of the chat room. This means they can configure the room, delete it, promote other users as admins, …
Consejo Starting with livechat v10.0.0, Peertube instance’s admins and moderators have no special rights on rooms by default. However, they have a special button available on top of the chat: “Become moderator”. Clicking this button will give them owner access on the room.
...
Mute anonymous users Información This feature comes with the livechat plugin version 10.2.0.
...
Aviso This section is still incomplete.
You can promote users as moderators, if you need some help.
Anonymize moderation actions Información This feature comes with the livechat plugin version 11.0.0.
...
You can choose to enable or disable this feature for new chatrooms on the channel configuration page.
Participant message history search Información This feature comes with the livechat plugin version 11.0.0.
As a room admin or owner, you can search all messages sent by a given participant.
To do so, you have several ways:
using the “Search all messages” action in the dropdown menu besides participants in the sidebar using the “Search all messages” action in the dropdown menu besides chat messages Consejo To have more space and better readability, open the chat in full-page mode.
...
From there, you can also promote yourself as room moderator by using the “Become moderator” button on the right.`,description:"Plugin peertube-plugin-livechat advanced moderation features",tags:[],title:"Moderation",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/moderation/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 10.2.0.
...
Información Peertube instance’s admin can also set global terms & conditions. If so, these terms will be shown above your channel’s terms.
Información Anonymous users will only see the terms & conditions once they have chosen their nickname (in other words: once they are able to talk).
...
This limitation does not apply to moderators.`,description:"Plugin peertube-plugin-livechat slow mode",tags:[],title:"Slow mode",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/slow_mode/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 10.3.0.
...
Aviso Currently, this feature has one known bug: users that join the chat will get all messages, even messages that are still pending for other participants. However, messages sent after they joined will be delayed correctly.
Consejo You can combine a short moderation delay (1 second for example) with the moderation bot to delete messages containing swear words before any non-moderator user will see them.
In the chat As a moderator, you will see the remaining time (in seconds) before the message is broadcasted, just besides the message datetime.`,description:"Plugin peertube-plugin-livechat moderation delay",tags:[],title:"Moderation delay",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/moderation_delay/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 10.1.0.
...
You can configure custom emojis for your channel. These emojis will be available in the emoji picker. Users can also use them by with their short name (for example by writing ":shortname:"). You can use emojis in the chat using ":shortname:". The short name can start and/or end by a colon (:), and only contain alphanumerical characters, underscores and hyphens. It is strongly recommended to start them by a colon, so that users can use autocompletion (by typing ":" then press TAB). Import / Export On the channel configuration page, there are an “Import” and an “Export” button. The “Export” button generates a file than you can then import on another channel.
...
[ { "sn": ":short_name:", "url": "https://example.com/image.png" } ] The sn attribute is the short name code. The url attribute can be any image url than your browser can access, or a Data URL representing the file you want to import.`,description:"Plugin peertube-plugin-livechat custom emojis",tags:[],title:"Custom emojis",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/emojis/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 10.2.0.
Create a poll You can create a new poll by using the “Create a new poll” action in the chat top menu:
Aviso This poll feature should not be considered as a reliable voting system. It is easy to cheat. There is no mechanism to prevent anonymous users to vote multiple times by just reloading the chat. Votes are never fully anonymous, someone having access to the server could see who voted for what choice.
...
Consejo Anonymous viewers can only vote once they have choosen their nickname.
...
Información For viewers using XMPP clients or outdated livechat plugin versions, the banner will not be visible. But they will see the message in the chat and will be able to vote by sending messages with their choices.
When the poll ends, a new message will be sent in the chat, with the results.
Información The only way to get old polls results is to search for the poll end message in the chat. For now, polls results are not saved by any other means. So don’t forget to note polls results if you want to keep them.`,description:"You can create polls to ask viewers their opinion.",tags:[],title:"Polls",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/polls/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 10.0.0.
Introduction The livechat plugin includes a Task Application: a kind of “to-do list” feature where you can create task lists and add tasks to them. Every room’s admins have access to these tasks, so you can edit them collaboratively.
...
Consejo To have more space and better readability, open the chat in full-page mode.
...
Consejo All modification are instantly visible in all your browser tabs, and for all room’s admins.
...
Using this feature, for example, you can ask your moderators to highlight all chat questions, so you can see them at a glance during your livestream, and check them as answered.`,description:"You can handle tasks and task lists with your moderation team.",tags:[],title:"Tasks / To-do lists",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/tasks/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 11.0.0.
Introduction The livechat plugin includes a Moderator Notes Application: you can write some notes, that could be associated to chat participants. Every room’s admins have access to these notes, so they can edit them collaboratively.
...
Aviso Currently the video vs channel rooms is an instance-wide settings. Only Peertube admins can change it, and it applies to all chatrooms. In the future, this choice will be added in your channel’s options.
...
Sorting notes You can sort notes simply using drag & drop.`,description:"Plugin peertube-plugin-livechat moderation notes",tags:[],title:"Moderation notes",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/moderation_notes/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 8.0.0, and can be disabled by your instance’s admins.
...
The bot will reload instantly when you save the page.`,description:"Chat bot setup",tags:[],title:"Chat bot",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/bot/index.html"},{breadcrumb:"Peertube livechat",content:"",description:"",tags:[],title:"Categorías",uri:"/peertube-plugin-livechat/es/categories/index.html"},{breadcrumb:"",content:`PeerTube plugin livechat Consejo You can use the language selector in the left menu to view this documentation in different languages. Some translations are missing or incomplete. In this case, you’ll see the English version of the text.
...
Consejo You can use the searchbox in the left menu to quickly find specific documentation parts.
Información Before updating to a major release, please read the release notes and breaking changes list : CHANGELOG.
IntroductionIntroduction
DocumentaciónPlugin documentation
...
Envianos tu feedbackEnvianos tu feedback
DesarrollarDesarrollar
DocumentaciónDocument the plugin, or translate the documentation.
...
ContáctameContacta con el autor
CreditsPlugin Credits`,description:"Peertube plugin livechat documentation",tags:[],title:"Peertube livechat",uri:"/peertube-plugin-livechat/es/index.html"},{breadcrumb:"Peertube livechat",content:"",description:"",tags:[],title:"Etiquetas",uri:"/peertube-plugin-livechat/es/tags/index.html"}]