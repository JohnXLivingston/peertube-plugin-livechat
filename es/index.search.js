...
You can also change your nickname using the chat menu.`,description:"How to chat for stream viewers",tags:[],title:"For viewers",uri:"/peertube-plugin-livechat/es/documentation/user/viewers/index.html"},{breadcrumb:"Peertube livechat > Documentación > Admin documentation",content:`This section describes the plugin settings page.
...
vendor The vendor folder is not part of the source code. It is used during the build process to download some external source code.`,description:"Source code organization",tags:[],title:"Source code",uri:"/peertube-plugin-livechat/es/technical/sourcecode/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers > Chat bot",content:`Forbid special characters Información This feature comes with the livechat plugin version 11.1.0.
...
Examples Don’t hesitate to share your rules. To do so, you can for example edit this page.`,description:"Advanced firewall rules for the Prosody server",tags:[],title:"Prosody mod_firewall",uri:"/peertube-plugin-livechat/es/documentation/admin/mod_firewall/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers > Chat bot",content:`Puedes configurar varios temporizadores que enviaran mensajes cada cierto intervalo. Estos mensages los enviara el bot cada X minutos. Puedes por ejemplo hacer que el bot muestre información de tus patrocinadores cada 5 minutos.
...
Enviar cada X minutos El bot publicará el mensaje cada X minutos.`,description:"The bot can send periodically some messages.",tags:[],title:"Timers",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/bot/quotes/index.html"},{breadcrumb:"Peertube livechat > Documentación > Admin documentation > Advanced usage",content:`This chat module is based on the XMPP protocol, also known as Jabber. It is therefore possible to connect to the chats using XMPP client software. This can for example be useful to facilitate moderation operations.
