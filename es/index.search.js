...
Activar chatpara todos los no - en vivos Si está marcada, el chat se habilitará para todos los vídeos que no sean en directo.
Activar chat para estos vídeos UUIDs de los videos para los cuales se desea un chat web. Pueden ser videos no en vivo. Una por línea. Puede agregar comentarios: todo lo que este detras del caracter # no sera interpretado y las líneas vacías ignoradas. No agregue videos privados, los UUID se enviarán al frontend.
...
Prosody puerto El puerto que sera usado por el servidor Prosody.
...
URL de Peertube para peticiones de API Por favor, deje esta configuración vacía si no sabe lo que está haciendo.
...
60: el contenido se guardará durante 60 segundos. Puede reemplazar 60 por cualquier valor entero. 1d: el contenido se guardará durante 1 día. Puede reemplazar 1 por cualquier valor entero. 1s: el contenido se guardará durante 1 semana. Puede reemplazar 1 por cualquier valor entero. 1m: el contenido se guardará durante 1 mes. Puede reemplazar 1 por cualquier valor entero. 1y: el contenido se guardará durante 1 año. Puede reemplazar 1 por cualquier valor entero. nunca: el contenido nunca caducará y se mantendrá para siempre. Activar conexión a la sala con cuentas XMPP externas Al habilitar esta opción, será posible conectarse a salas utilizando cuentas XMPP externas y clientes XMPP.
...
Interfaces de red de servidor a servidor Las interfaces de red para escuchar conexiones de servidor a servidor.
...
Ejemplos:
*, :: * 127.0.0.1, ::1 172.18.0.42 Directorio de certificados Si este campo está vacío, el plugin generará y utilizará certificados autofirmados.
...
Activar las conexiones cliente-servidor Habilitar clientes XMPP para conectarse al servidor Prosody integrado.
...
OBS Dock Información This feature comes with the livechat plugin version 10.1.0. Aviso This feature can be disabled by the instance’s adminitrators.
...
Forbidden wordsThe bot can automatically moderate messages containing forbidden words.
TimersThe bot can send periodically some messages.
CommandsThe bot can respond to several commands.`,description:"How to setup the chat for your live stream",tags:[],title:"For streamers",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 12.0.0. Room owners and administrators can send special announcements in the chat.
...
Standard: to send a standard message. Highlight: these messages will simply be highlighted in a blue box. Announcement: these messages will be in a green box, and a bold “Announcement” title will be added. Warning: these messages will be in a rend box, and a bold “Announcement” title will be added. Información User that are not owner or administrator of the chatroom can’t send such messages.
Aviso Note: Standards XMPP clients will display announcements as standard messages.`,description:"Room owners and administrators can send special announcements in the chat.",tags:[],title:"Announcements",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/announcements/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Aviso This section is still incomplete.
...
Mute anonymous users Información This feature comes with the livechat plugin version 10.2.0. You can prevent anonymous users to send messages. In such case, only registered users will be able to talk in the chat.
...
Anonymize moderation actions Información This feature comes with the livechat plugin version 11.0.0. It is possible to anonymize moderation actions, to avoid disclosing who is banning/kicking/… occupants.
...
You can choose to enable or disable this feature for new chatrooms on the channel configuration page.
Participant message history search Información This feature comes with the livechat plugin version 11.0.0. As a room admin or owner, you can search all messages sent by a given participant.
...
From there, you can also promote yourself as room moderator by using the “Become moderator” button on the right.`,description:"Plugin peertube-plugin-livechat advanced moderation features",tags:[],title:"Moderation",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/moderation/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 10.2.0. Configuration You can add terms & conditions to your channel. These terms will be shown to all users joining the chat.
...
This limitation does not apply to moderators.`,description:"Plugin peertube-plugin-livechat slow mode",tags:[],title:"Slow mode",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/slow_mode/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 10.3.0. Introduction As a streamer, you can choose to delay messages in the chat, to let some time to moderators to delete messages before they can even be read by other participants.
...
Consejo You can combine a short moderation delay (1 second for example) with the moderation bot to delete messages containing swear words before any non-moderator user will see them.
In the chat As a moderator, you will see the remaining time (in seconds) before the message is broadcasted, just besides the message datetime.`,description:"Plugin peertube-plugin-livechat moderation delay",tags:[],title:"Moderation delay",uri:"/peertube-plugin-livechat/es/documentation/user/streamers/moderation_delay/index.html"},{breadcrumb:"Peertube livechat > Documentación > User documentation > For streamers",content:` Información This feature comes with the livechat plugin version 10.1.0. Channel emojis Streamers can add custom emojis to their channels.
