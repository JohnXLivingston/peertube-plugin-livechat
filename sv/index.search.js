...
Aktivera chatten för dessa videor Videos UUIDs for which we want a web chat (short UUID or UUIDv4). Can be non-live videos. One per line. You can add comments: everything after the # character will be stripped off, and empty lines ignored.
...
You can fill several “Förbjudna ord och uttryck” lines. When a user sends a message that match the configured criteria, the message will automatically be deleted.
Förbjudna ord och uttryck Here you can configure several words, group of words, or “regular expressions”.
...
By checking this option, each line of the “Förbjudna ord och uttryck” field will be considered as a regular expression.
