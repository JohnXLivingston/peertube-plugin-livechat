...
Wenn Sie ein Peertube Konto auf einer anderen Peertube Instanz haben Info This feature comes with the livechat plugin version 9.0.0. Wenn Sie ein Peertube Konto haben, aber nicht auf der aktuellen Instanz, gibt es einen “Mit einem externem Account anmelden”-Button. Diese Schaltfläche öffnet einen Dialog, in dem Sie die URL Ihrer Peertube Instanz eingeben können. Sobald Sie diese eingegeben haben, wird geprüft, ob das Livechatplugin auf der entfernten Instanz verfügbar ist und ob das Video verfügbar ist. Wenn dies der Fall ist, werden Sie zu dem Video auf der entfernten Instanz weitergeleitet.
...
OBS Dock Info This feature comes with the livechat plugin version 10.1.0. Warnung Diese Funktion kann von den Administratoren der Instanz deaktiviert werden.
...
Anonyme Benutzer stummschalten Info This feature comes with the livechat plugin version 10.2.0. Sie können anonyme Benutzer daran hindern, Nachrichten zu senden. In diesem Fall können nur registrierte Benutzer im Chat schreiben.
...
Moderationsaktionen anonymisieren Info This feature comes with the livechat plugin version 11.0.0. Es ist möglich, Moderationsaktionen zu anonymisieren, um zu vermeiden, dass bekannt wird, wer Teilnehmer bannt/verweist/…
...
Sie können diese Funktion für neue Chaträume auf der Kanal-Konfigurationsseite aktivieren oder deaktivieren.
Im Nachrichtenverlauf eines Teilnehmers suchen Info This feature comes with the livechat plugin version 11.0.0. Als Raumadministrator oder -besitzer können Sie alle von einem bestimmten Teilnehmer gesendeten Nachrichten durchsuchen.
...
Von dort aus kannst du dich auch als Moderator des Raums bewerben, indem du die Schaltfläche “Moderator werden” auf der rechten Seite benutzt.`,description:"Plugin peertube-plugin-livechat Erweiterte Moderationsfunktionen",tags:[],title:"Moderation",uri:"/peertube-plugin-livechat/de/documentation/user/streamers/moderation/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer",content:` Info This feature comes with the livechat plugin version 10.2.0. Konfiguration Sie können Ihrem Kanal Nutzungsbedingungen hinzufügen. Diese Nutzungsbedingungen werden allen Benutzern angezeigt, die den Chat betreten.
...
Info Die einzige Möglichkeit, alte Umfrageergebnisse zu erhalten, ist die Suche nach der Nachricht über das Ende der Umfrage im Chat. Im Moment werden die Umfrageergebnisse nicht auf andere Weise gespeichert. Vergessen Sie also nicht, die Umfrageergebnisse zu notieren, wenn Sie sie behalten wollen.`,description:"Sie können Umfragen erstellen, um die Zuschauer nach ihrer Meinung zu fragen",tags:[],title:"Umfragen",uri:"/peertube-plugin-livechat/de/documentation/user/streamers/polls/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer",content:` Info This feature comes with the livechat plugin version 10.0.0. Einführung Das Livechat Plugin enthält eine Aufgabenanwendung: eine Art “To-Do-Liste”, mit der Sie Aufgabenlisten erstellen und Aufgaben zu ihnen hinzufügen können. Die Administratoren eines jeden Raums haben Zugriff auf diese Aufgaben, sodass Sie sie gemeinsam bearbeiten können.
