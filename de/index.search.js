...
Chat-Nutzungsbedingungen des Kanals Du kannst eine „Nutzungsbedingungen“-Nachricht konfigurieren, die Benutzern angezeigt wird, die deinen Chaträumen beitreten.
...
Chats von anderen Instanzen nicht anzeigen Wenn du diese Einstellung aktivierst, werden in deiner Instanz niemals Chats von Videos anderer Instanzen angezeigt.
Chat-Information nicht veröffentlichen Wenn du diese Einstellung aktivierst, wird deine Instanz keine Chat-Informationen im Fediverse veröffentlichen. Andere Peertube-Instanzen wissen nicht, dass mit deinen Videos Chaträume verbunden sind.
...
Aktivieren regulärer Ausdrücke für verbotene Wörter in Chaträumen Wird diese Funktion aktiviert, können Streamer bei der Konfiguration des Chatbots reguläre Ausdrücke verwenden. Du solltest diese Funktion nicht aktivieren, wenn du deinen Nutzern nicht traust (d. h. denjenigen, die Chaträume erstellen können, mit anderen Worten: denjenigen, die Live-Streams erstellen können). Ein böswilliger Benutzer könnte einen speziell gestalteten regulären Ausdruck erstellen und einen Denial-of-Service (DoS) des Bots verursachen.
Chatverhalten Raumtyp Du kannst hier wählen, ob du für jedes Video einen eigenen Raum haben möchtest oder ob du sie nach Kanälen gruppieren möchtest.
Chat automatisch öffnen Wenn ausgewählt, wird der Chat geladen, sobald du auf der Videoseite bist.
...
Chat für alle Nicht-Live-Videos aktivieren Wenn diese Option aktiviert ist, wird der Chat für alle Videos aktiviert, die keine Live-Videos sind.
Chat für diese Videos aktivieren Videos-UUIDs, für die wir einen Webchat wollen (kurz UUID oder UUIDv4). Es können auch Nicht-Livestream-Videos sein. Ein Video pro Zeile. Du kannst Kommentare hinzufügen: alles nach dem #-Zeichen wird entfernt, und leere Zeilen werden ignoriert. Füg keine privaten Videos hinzu, die UUIDs werden an das Frontend gesendet.
...
Webchat-Iframe Stil-Attribut Du kannst einige benutzerdefinierte Styles hinzufügen, die dem Iframe hinzugefügt werden. Beispiel: width:400px;
...
Websocket deaktivieren Mit Peertube >= 5.0.0 versucht dieses Plugin, eine Websocket-Verbindung zum Chatten zu verwenden. Wenn der Browser oder die Verbindung des Benutzers nicht kompatibel ist, wird der Browser automatisch auf das BOSH-Protokoll zurückgreifen. Aber in seltenen Fällen kann dies fehlschlagen. Zum Beispiel, wenn du einen Reverse-Proxy vor Peertube hast, der keine Websocket-Verbindung für Plugins erlaubt. In diesem Fall kannst du diese Einstellungen überprüfen, um Websocket-Verbindungen zu deaktivieren.
Prosody-Port Der Port, der vom integrierten Prosody-Server verwendet wird.
...
Peertube-URL für API-Aufrufe Bitte lass diese Einstellungen leer, wenn du nicht weißst, was du tust.
...
Ablaufzeit von Raumprotokollen Du kannst hier auswählen, wie lange der Inhalt des Chatrooms vom Server aufbewahrt wird. Der Wert kann sein:
60: Der Inhalt wird für 60 Sekunden gespeichert. Du kannst 60 durch einen beliebigen ganzzahligen Wert ersetzen. 1d: Der Inhalt wird für 1 Tag gespeichert. Du kannst 1 durch einen beliebigen ganzzahligen Wert ersetzen. 1w: Der Inhalt wird für 1 Woche gespeichert. Du kannst 1 durch einen beliebigen ganzzahligen Wert ersetzen. 1m: Der Inhalt wird für 1 Monat gespeichert. Du kannst 1 durch einen beliebigen ganzzahligen Wert ersetzen. 1y: Der Inhalt wird für 1 Jahr gespeichert. Du kannst 1 durch einen beliebigen ganzzahligen Wert ersetzen. never: Der Inhalt läuft nie ab und wird für immer aufbewahrt. Verbindung zum Raum mit externen XMPP-Konten aktivieren Durch Aktivieren dieser Option ist es möglich, über externe XMPP-Konten und XMPP-Clients eine Verbindung zu Räumen herzustellen.
Achtung: Durch die Aktivierung dieser Option können zusätzliche Server- und DNS-Konfigurationen erforderlich sein. Bitte beachte die Dokumentation: Externe XMPP-Kontoverbindungen aktivieren. Prosody-Server-Port zu Server-Port Der Port, der für XMPP s2s-Verbindungen (Server zu Server) verwendet wird.
Du solltest den Standardport 5269 verwenden. Andernfalls musst du einen bestimmten DNS-Eintrag erstellen .
Server-zu-Server-Netzwerkschnittstellen Die Netzwerkschnittstellen, die für Server-zu-Server-Verbindungen verwendet werden sollen.
...
Beispiele:
*, :: * 127.0.0.1, ::1 172.18.0.42 Zertifikate-Ordner Wenn dieses Feld leer ist, erzeugt und verwendet das Plugin selbstsignierte Zertifikate.
...
Aktivieren von Client-Server-Verbindungen Ermögliche Sie XMPP-Clients die Verbindung zum integrierten Prosody-Server.
...
Client-zu-Server-Netzwerkschnittstellen Die Netzwerkschnittstellen, die für Client-Server-Verbindungen überwacht werden sollen.
...
Aktivieren externer XMPP-Komponenten Aktiviere die Verwendung externer XMPP-Komponenten.
...
Port für externe Komponenten zur Verbindung mit Prosody Der Port, der von XMPP-Komponenten verwendet wird, um sich mit dem Prosody-Server zu verbinden.
Ändere ihn, wenn dieser Port bereits auf deinem Server verwendet wird.
...
Prosody-externe-Komponenten-Netzwerkschnittstellen Die Netzwerkschnittstellen, die für externe Komponentenverbindungen überwacht werden sollen.
Liste der zu überwachenden IP, durch Kommata getrennt (Leerzeichen werden entfernt).
Man kann „*“ verwenden, um auf allen IPv4-Schnittstellen zu lauschen, und „::“ für alle IPv6-Schnittstellen.
Beispiele:
*, :: * 127.0.0.1, ::1 172.18.0.42 Externe Komponenten Die zu erstellenden externen Komponenten:
Eine pro Zeile. Verwende das Format „Komponentenname:Komponenten_Geheimnis“ (Leerzeichen werden entfernt) Man kann Kommentare hinzufügen: alles nach dem #-Zeichen wird entfernt und leere Zeilen werden ignoriert. Der Name darf nur alphanumerische Zeichen und Punkte enthalten Wenn der Name nur alphanumerische Zeichen enthält, wird ihm die XMPP-Domäne angehängt. Aus „bridge“ wird zum Beispiel „bridge.your_domain.tld“. Du kannst auch einen vollständigen Domänennamen angeben, musst jedoch sicherstellen, dass dein DNS korrekt konfiguriert ist. Verwende nur alphanumerische Zeichen in der geheimen Passphrase (verwende mindestens 15 Zeichen). Prosody mod_firewall einschalten Sie können mod_firewall auf Ihrem Prosody-Server aktivieren.
...
Wenn Sie ein Peertube Konto auf einer anderen Peertube Instanz haben Info Diese Funktion wird mit dem Livechatplugin Version 9.0.0 verfügbar sein. Wenn Sie ein Peertube Konto haben, aber nicht auf der aktuellen Instanz, gibt es einen “Mit einem externem Account anmelden”-Button. Diese Schaltfläche öffnet einen Dialog, in dem Sie die URL Ihrer Peertube Instanz eingeben können. Sobald Sie diese eingegeben haben, wird geprüft, ob das Livechatplugin auf der entfernten Instanz verfügbar ist und ob das Video verfügbar ist. Wenn dies der Fall ist, werden Sie zu dem Video auf der entfernten Instanz weitergeleitet.
...
Wenn Ihnen ein Standardanbieter einfällt, der noch nicht verfügbar ist, können Sie um die Implementierung bitten, indem Sie ein neues Problem eröffnen.
...
Allgemeine Empfehlungen Bitte formulieren Sie umfassend und beachten Sie den Verhaltenskodex.`,description:"Das Plugin übersetzen",tags:[],title:"Übersetzen",uri:"/peertube-plugin-livechat/de/contributing/translate/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer > Chatbot",content:`Du kannst einige Wörter konfigurieren, die vom Chatbot automatisch moderiert werden (Nachrichten, die solche Wörter enthalten, werden sofort gelöscht). Du kannst auch einen optionalen Grund hinzufügen, der an der Stelle der gelöschten Nachrichten angezeigt wird. Mehrere Beispiele findet man auf der Dokumentationsseite.
Sie können mehrere “Verbotene Wörter oder Ausdrücke”-Zeilen ausfüllen. Wenn ein Benutzer eine Nachricht sendet, die den konfigurierten Kriterien entspricht, wird die Nachricht automatisch gelöscht.
Verbotene Wörter oder Ausdrücke Hier können Sie mehrere Wörter, Wortgruppen oder “reguläre Ausdrücke” (regex) konfigurieren.
...
Beispiele Zögern Sie nicht, Ihre Regeln zu teilen. Um dies zu tun, können Sie zum Beispiel diese Seite bearbeiten.`,description:"Erweiterte Firewall-Regeln für den Prosody-Server",tags:[],title:"Prosody mod_firewall",uri:"/peertube-plugin-livechat/de/documentation/admin/mod_firewall/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer > Chatbot",content:`Du kannst mehrere voraufgezeichnete Nachrichten (Timer) konfigurieren, die in regelmäßigen Abständen gesendet werden. Diese Nachrichten werden vom Chatbot alle X Minuten gesendet. Du kannst beispielsweise festlegen, dass der Bot alle 5 Minuten eine Sponsor-Information sendet.
Tipp Wenn sich kein Benutzer im Chatraum befindet, sendet der Chatbot keine Nachricht.
Timer Du kannst mehrere voraufgezeichnete Nachrichten (Timer) konfigurieren, die in regelmäßigen Abständen gesendet werden. Diese Nachrichten werden vom Chatbot alle X Minuten gesendet. Du kannst beispielsweise festlegen, dass der Bot alle 5 Minuten eine Sponsor-Information sendet.
...
OBS Dock Info Diese Funktion wird mit dem Livechatplugin Version 10.1.0 verfügbar sein. Warnung Diese Funktion kann von den Administratoren der Instanz deaktiviert werden.
...
ÜbersetzenDas Plugin übersetzen
...
Vielen Dank an David Revoy für seine Arbeit am Peertube-Maskottchen, Sepia. Das Charakterdesign steht unter CC-By-Lizenz, und die SVG-Dateien, die zur Erstellung einiger Logos und Avatare in diesem Plugin verwendet wurden, stehen unter GPLv3.0. Die PNG-Dateien stehen unter CC-By-Lizenzen und stammen aus dem Sepia Avatar Generator, dem Katzen Avatar Generator, dem Vogel Avatar Generator, dem Fennek/Mobilizon Avatar Generator und dem Abstrakt Avatar Generator.
...
Anonyme Benutzer stummschalten Info Diese Funktion wird mit dem Livechatplugin Version 10.2.0 verfügbar sein. Sie können anonyme Benutzer daran hindern, Nachrichten zu senden. In diesem Fall können nur registrierte Benutzer im Chat schreiben.
...
Moderationsaktionen anonymisieren Info Diese Funktion wird mit dem Livechatplugin Version 11.0.0 verfügbar sein. Es ist möglich, Moderationsaktionen zu anonymisieren, um zu vermeiden, dass bekannt wird, wer Teilnehmer bannt/verweist/…
...
Sie können diese Funktion für neue Chaträume auf der Kanal-Konfigurationsseite aktivieren oder deaktivieren.
Im Nachrichtenverlauf eines Teilnehmers suchen Info Diese Funktion wird mit dem Livechatplugin Version 11.0.0 verfügbar sein. Als Raumadministrator oder -besitzer können Sie alle von einem bestimmten Teilnehmer gesendeten Nachrichten durchsuchen.
...
Von dort aus kannst du dich auch als Moderator des Raums bewerben, indem du die Schaltfläche “Moderator werden” auf der rechten Seite benutzt.`,description:"Plugin peertube-plugin-livechat Erweiterte Moderationsfunktionen",tags:[],title:"Moderation",uri:"/peertube-plugin-livechat/de/documentation/user/streamers/moderation/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer",content:` Info Diese Funktion wird mit dem Livechatplugin Version 10.2.0 verfügbar sein. Konfiguration Sie können Ihrem Kanal Nutzungsbedingungen hinzufügen. Diese Nutzungsbedingungen werden allen Benutzern angezeigt, die den Chat betreten.
...
Info Wenn Ihre Peertube-Instanz die Teilnahme am Chat mit XMPP-Clients erlaubt, sehen die Benutzer, die solche Clients verwenden, die Bedingungen als Chat-Nachrichten, die von einem “Peertube”-Konto kommen. Wenn Sie die Bedingungen aktualisieren, erhalten sie eine neue Nachricht mit dem Inhalt der aktualisierten Bedingungen.`,description:"Konfigurieren Sie die Chat-Nutzungsbedingungen für den Kanal",tags:[],title:"Nutzungsbedingungen",uri:"/peertube-plugin-livechat/de/documentation/user/streamers/terms/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer",content:` Info Diese Funktion wird mit dem Livechatplugin Version 8.3.0 verfügbar sein. Einführung Als Streamer haben Sie die Möglichkeit, die Anzahl der Nachrichten Ihrer Zuschauer im Chat zeitlich zu begrenzen.
...
Diese Einschränkung gilt nicht für Moderatoren.`,description:"Plugin peertube-plugin-livechat Langsamer Modus",tags:[],title:"Langsamer Modus",uri:"/peertube-plugin-livechat/de/documentation/user/streamers/slow_mode/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer",content:` Info Diese Funktion wird mit dem Livechatplugin Version 10.3.0 verfügbar sein. Einführung Als Streamer können Sie Nachrichten im Chat verzögern, um Moderatoren etwas Zeit zu geben, Nachrichten zu löschen, bevor sie von anderen Teilnehmern gelesen werden können.
...
Tipp Sie können eine kurze Moderationsverzögerung (z.B. 1 Sekunde) mit dem Moderations-Chatbot kombinieren, um Nachrichten mit Schimpfwörtern zu löschen, bevor ein Nicht-Moderator sie sieht.
Im Chat Als Moderator sehen Sie neben dem Datum der Nachricht auch die verbleibende Zeit (in Sekunden), bevor die Nachricht veröffentlicht wird.`,description:"Plugin peertube-plugin-livechat Moderationsverzögerung",tags:[],title:"Moderationsverzögerung",uri:"/peertube-plugin-livechat/de/documentation/user/streamers/moderation_delay/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer",content:` Info Diese Funktion wird mit dem Livechatplugin Version 10.1.0 verfügbar sein. Kanal-Emojis Streamer können benutzerdefinierte Emojis zu ihren Kanälen hinzufügen.
Öffnen Sie auf der Kanal Konfigurationsseite die Registerkarte “Kanal-Emojis”:
Du kannst benutzerdefinierte Emojis für deinen Kanal konfigurieren. Diese Emojis werden in der Emoji-Auswahl verfügbar sein. Benutzer können sie auch mit ihrem Kurznamen verwenden (z. B. indem sie „:Kurzname:“ schreiben).
Man kann Emojis im Chat mit „:Kurzname:“ verwenden. Der Kurzname kann mit einem Doppelpunkt (:) beginnen und/oder enden und darf nur alphanumerische Zeichen, Unterstriche und Bindestriche enthalten. Es wird dringend empfohlen, sie mit einem Doppelpunkt zu beginnen, damit die Benutzer die automatische Vervollständigung nutzen können (indem sie „:“ eingeben und dann TAB drücken).
...
[ { "sn": ":short_name:", "url": "https://example.com/image.png" } ] Das Attribut sn ist der Kurznamencode. Das Attribut url kann eine beliebige Bild-URL sein, auf die Ihr Browser zugreifen kann, oder eine Daten-URL, die die zu importierende Datei darstellt.`,description:"Plugin peertube-plugin-livechat benutzerdefinierte Emojis",tags:[],title:"Benutzerdefinierte Emojis",uri:"/peertube-plugin-livechat/de/documentation/user/streamers/emojis/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer",content:` Info Diese Funktion wird mit dem Livechatplugin Version 12.0.0 verfügbar sein. Nur-Emojis-Modus Du kannst in deinen Chaträumen einen „Nur-Emoji-Modus“ aktivieren. Wenn dieser Modus aktiviert ist, können die Teilnehmer nur Emojis (Standard- oder kanaleigene Emojis) senden. Moderatoren sind von dieser Einschränkung nicht betroffen.
...
Wenn Sie es für alle Ihre Chaträume auf einmal aktivieren möchten, öffnen Sie die Kanal Emojis Konfigurationsseite, und benutzen Sie die “Den Nur-Emojis-Modus in allen Chaträumen des Kanals aktivieren” Schaltfläche.`,description:"Plugin peertube-plugin-livechat nur Emojis Modus",tags:[],title:"Nur Emojis-Modus",uri:"/peertube-plugin-livechat/de/documentation/user/streamers/emojis_only/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer",content:` Info Diese Funktion wird mit dem Livechatplugin Version 10.2.0 verfügbar sein. Eine Umfrage erstellen Sie können eine neue Umfrage erstellen, indem Sie die Aktion “Eine neue Umfrage erstellen” im oberen Menü des Chats verwenden:
...
Info Die einzige Möglichkeit, alte Umfrageergebnisse zu erhalten, ist die Suche nach der Nachricht über das Ende der Umfrage im Chat. Im Moment werden die Umfrageergebnisse nicht auf andere Weise gespeichert. Vergessen Sie also nicht, die Umfrageergebnisse zu notieren, wenn Sie sie behalten wollen.`,description:"Sie können Umfragen erstellen, um die Zuschauer nach ihrer Meinung zu fragen",tags:[],title:"Umfragen",uri:"/peertube-plugin-livechat/de/documentation/user/streamers/polls/index.html"},{breadcrumb:"Peertube livechat > Dokumentation > Benutzer Dokumentation > Für Streamer",content:` Info Diese Funktion wird mit dem Livechatplugin Version 10.0.0 verfügbar sein. Einführung Das Livechat Plugin enthält eine Aufgabenanwendung: eine Art “To-Do-Liste”, mit der Sie Aufgabenlisten erstellen und Aufgaben zu ihnen hinzufügen können. Die Administratoren eines jeden Raums haben Zugriff auf diese Aufgaben, sodass Sie sie gemeinsam bearbeiten können.
