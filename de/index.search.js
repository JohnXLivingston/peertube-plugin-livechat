...
Chat-Information nicht veröffentlichen Wenn Sie diese Einstellung aktivieren, wird Ihre Instanz keine Chat Informationen im Fediverse veröffentlichen. Andere Peertube-Instanzen wissen nicht, dass mit Ihren Videos Chaträume verbunden sind.
...
Chat für diese Videos aktivieren Videos UUIDs, für die wir einen Webchat wollen (kurz UUID oder UUIDv4). Es können auch Nicht-Livestream-Videos sein. Ein Video pro Zeile. Sie können Kommentare hinzufügen: alles nach dem #-Zeichen wird entfernt, und leere Zeilen werden ignoriert. Fügen Sie keine privaten Videos hinzu, die UUIDs werden an das Frontend gesendet.
...
Peertube-URL für API-Aufrufe Bitte lassen Sie diese Einstellungen leer, wenn Sie nicht wissen, was Sie tun.
...
60: Der Inhalt wird 60 Sekunden gespeichert. Sie können 60 durch einen beliebigen ganzzahligen Wert ersetzen. 1d: Der Inhalt wird für 1 Tag gespeichert. Sie können 1 durch einen beliebigen ganzzahligen Wert ersetzen. 1w: Der Inhalt wird für 1 Woche gespeichert. Sie können 1 durch einen beliebigen ganzzahligen Wert ersetzen. 1m: Der Inhalt wird für 1 Monat gespeichert. Sie können 1 durch einen beliebigen ganzzahligen Wert ersetzen. 1y: Der Inhalt wird für 1 Jahr gespeichert. Sie können 1 durch einen beliebigen ganzzahligen Wert ersetzen. nie: Der Inhalt läuft nie ab und wird für immer aufbewahrt. Verbindung zum Raum mit externen XMPP Konten aktivieren Durch Aktivieren dieser Option ist es möglich, über externe XMPP-Konten und XMPP-Clients eine Verbindung zu Räumen herzustellen.
...
Aktivieren von Client-Server-Verbindungen Ermöglichen Sie XMPP-Clients die Verbindung zum integrierten Prosody-Server.
