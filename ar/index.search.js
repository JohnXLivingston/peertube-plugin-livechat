...
بقشيش You can test the livechat plugin with this demo page.
التثبيت As a Peertube administrator, you can setup this plugin on your instance simply by using the Peertube plugin marketplace included in the administration interface. Search for “livechat”, then click “install”: that’s it!
...
الفديرالية Peertube is part of the fediverse: you can create a network of Peertube instances, sharing content between them.
...
الإشراف Some times, you have to protect your community from bad people. As an instance administrator, you can choose to disallow federation for the livechat plugin. If remote actors behave badly, streamers, moderators and administrators can ban or mute users.
روبوت محادثة This plugin comes with a built-in chat bot. Check its documentation for more information.
...
استخدامات أخرى By default, each streamer will be able to activate/deactivate the chat for their live streams.
But on the instance level, administrators can choose to activate the chat for all videos (live and/or VOD).
You can even activate the chat for specific VOD videos. This is how the demo page works: it is not a live stream, but I have activated the chat specifically for this video.`,description:"مقدمة",tags:[],title:"مقدمة",uri:"/peertube-plugin-livechat/ar/intro/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم",content:`الإلتحاق بغرف المحادثة When you are watching a Peertube video that has the chat activated, you will see the chat next to the video:
...
If you haven’t a Peertube account تحذير This feature can be disabled by the instance’s adminitrators.
...
Log in using an external authentication provider تحذير This feature can be disabled by the instance’s adminitrators.
...
الدردشة To send messages, just type them in the “message” field on the bottom of the screen. You can send them by pressing the enter key on your keyboard, or by clicking on the “send” button.
...
قائمة المشاركين To see the list of participants, just open the right menu:
...
معلومات Changing this setting will restart the chat server, and all users will be disconnected for a short time.
قائمة قنوات الدردشة الموجودة When pressing the «List rooms» button, all existing chatrooms will be listed. You can then find them and moderated them.
الفديرالية Following settings concern the federation with other Peertube instances, and other fediverse softwares.
...
الإستيثاق Disable livechat tokens In case you have any trouble with the long term authentication tokens, you can disable the feature here.
استيثاق خارجي See the detailed documentation page:
...
تفعيل الدردشة على كافة المباشرات If checked, the chat will be enabled for all lives.
...
تخصيص المظهر مجموعة الصور الرمزية You can choose from several different sets the default avatars that will be used for chat users.
Sepia (Peertube mascot): David Revoy’s Peertube avatar generator, CC-By license
قطط: David Revoy’s cat avatar generator, CC-By license
عصافير: David Revoy’s bird avatar generator, CC-By license
...
Peertube theme: this is a special theme, made especially for peertube’s integration. Default ConverseJS theme: this is the default ConverseJS theme. ConverseJS cyberpunk theme: this is a theme provided by ConverseJS. استكشاف تلقائي للألوان Try to autodetect colors from user’s current theme.
...
Chat server advanced settings استخدم خدمة Prosody المثبتة على النظام The plugin comes with an AppImage that is used to run the Prosody XMPP server. If this AppImage is not working, you can fallback to the Prosody that is packaged for your server. Just install the prosody package.
...
منفذ Prosody The port that will be used by the Prosody server.
...
Warning, enabling this option can request extra server and DNS configuration. Please refer to the documentation: Enable external XMPP account connections. منفذ Prosody مِن خادم إلى خادم آخر The port that will be used for XMPP s2s (server to server) connections.
...
You can use «*» to listen on all IPv4 interfaces, and «::» for all IPv6.
Examples:
*, :: * 127.0.0.1, ::1 172.18.0.42 المكونات الخارجية The external components to declare:
...
For more information, please check the documentation.`,description:"Plugin Peertube Livechat settings",tags:[],title:"الإعدادات",uri:"/peertube-plugin-livechat/ar/documentation/admin/settings/index.html"},{breadcrumb:"Peertube livechat",content:` دليل المستخدمPlugin peertube-plugin-livechat user documentation
...
دليل التثبيتPlugin peertube-plugin-livechat installation guide
في حال مشكلةSome classic mistakes and workarounds.
...
مستندات الإدارةPlugin Peertube Livechat administration
الإعداداتPlugin Peertube Livechat settings
استيثاق خارجيPlugin Peertube Livechat settings - External Authentication
Prosody mod_firewallAdvanced firewall rules for the Prosody server
استخدام متقدمبعض الميزات المتقدمة
XMPP clientsAllow connections using XMPP clients
استخدم MatterbridgeUsing Matterbridge to bridge with other chats`,description:"مستندات الملحق",tags:[],title:"المستندات",uri:"/peertube-plugin-livechat/ar/documentation/index.html"},{breadcrumb:"Peertube livechat > المستندات",content:` For viewersHow to chat for stream viewers
OBSDocumentation to stream the chat content using OBS.
XMPP ClientsConnect to chat using a XMPP client
للناشرين على المباشرHow to setup the chat for your live stream
بعض الأساسياتSome basics about how to setup and use the chat for your live stream
...
الأوامرThe bot can respond to several commands.`,description:"Plugin peertube-plugin-livechat user documentation",tags:[],title:"دليل المستخدم",uri:"/peertube-plugin-livechat/ar/documentation/user/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل التثبيت",content:`I just installed/upgraded the plugin, but nothing happens If you have just installed/upgraded the plugin, but nothing happens (no chat, no settings, buttons in the settings page does not work, …), just try to reload the page.
أدوات الفحص If the chat does not work, there is a diagnostic tool in the plugin’s settings pages.
...
If you can’t fix this immediatly, you can disable Websocket by unchecking “Disable Websocket” in the plugin setting page. In such case, you should also check “Don’t publish chat information”, as chat federation won’t work without Websocket.`,description:"Some classic mistakes and workarounds.",tags:[],title:"في حال مشكلة",uri:"/peertube-plugin-livechat/ar/documentation/installation/troubleshooting/index.html"},{breadcrumb:"Peertube livechat > المساهمة",content:` بقشيش This Code of Conduct is adapted from the Contributor Covenant, version 2.1, available at https://www.contributor-covenant.org/version/2/1/code_of_conduct.html. Translations are available at https://www.contributor-covenant.org/translations. Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement by mail at git.[at].john-livingston.fr.
...
OpenID Connect تحذير This feature is still experimental. This feature is available with the plugin version >= 9.0.0.
...
في حال مشكلة If the button does not appear for end users, there might be a configuration issue. You can try the diagnostic tool to get more information.
...
المزيد لاحقا… Other authentication methods will be implemented in the future.`,description:"Plugin Peertube Livechat settings - External Authentication",tags:[],title:"استيثاق خارجي",uri:"/peertube-plugin-livechat/ar/documentation/admin/external_auth/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل التثبيت",content:`The Prosody AppImage included in the plugin will only work on x86_64 and arm64 CPU. It is not compatible with other CPU architectures.
...
opening a web page (with an url like https://yourinstance.tld/plugins/livechat/router/webchat/room/8df24108-6e70-4fc8-b1cc-f2db7fcdd535), using a XMPP client (and joining a room like xmpp://8df24108-6e70-4fc8-b1cc-f2db7fcdd535@room.yourinstance.tld?join) تحذير Joining the chat using a XMPP client is not always possible. It requires some DNS and server configuration. It will only be possible if instance’s admins have correctly setup the external XMPP clients connection feature.
تحذير Don’t try to gues these url and connection methods yourself. Please report to next chapters.
...
معلومات This requires Peertube >= 5.1
This follows the FEP-1970 recommendations.
تحذير At the time of the writing, this FEP is in draft status, and the livechat plugin is a Proof-of-concept. Until the FEP is adopted, the specification can change, and the livechat plugin will be adapted accordingly.
...
معلومات This requires Peertube >= 5.2
معلومات The <podcast:chat> element is currently only supported for live streams.
This follows the <podcast:chat> proposal.
تحذير At the time of the writing, this proposal is in draft status, and the livechat plugin is a Proof-of-concept. Until the proposal is adopted, the specification can change, and the livechat plugin will be adapted accordingly.
...
بقشيش These words are case insensitive.
...
تحذير This features is still experimental. There might be some issues with non-latin alphabets. You can open an issue to report your problems.
Consider as regular expressions تحذير This feature can be disabled by the instance’s adminitrators.
...
السبب Reason to display besides deleted messages
التعليقات You can add here some comments about this rule, to remember how and why you created it. These comments are purely indicative, and have no influence on the bot’s behavior.`,description:"The bot can automatically moderate messages containing forbidden words.",tags:[],title:"المصطلحات الممنوعة",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/bot/forbidden_words/index.html"},{breadcrumb:"Peertube livechat > المساهمة",content:`You can contribute to this plugin translation. Translations are handled using the Weblate software, using Framasoft Weblate instance.
تحذير Never modify directly files in the languages folder, this could lead to conflicts.
كيف ذلك Create an account: https://weblate.framasoft.org/accounts/register/ Validate your email and follow the link sent Create your password and setup your account Go to the plugin project page: https://weblate.framasoft.org/projects/peertube-livechat/peertube-plugin-livechat/ Choose the locale you want to translate Just translate missing sentences, or correct the ones that seems incorrect to you. تحذير There might be some «very technical» strings. If you are not 100% sure of the meaning, or of your translation, you better not translate it, so it will display in english.
ترجمات ConverseJS This plugin relies on ConverseJS for the chat front-end. ConverseJS has its own translations, on its own weblate instance. You can also translate directly in the code repository. For more information, check ConverseJS translations documentation.
...
ترجمة الدليل The documentation translation is done using the corresponding Weblate component.
...
Generic recommandations Please be inclusive in your wordings, and please respect the code of coduct.`,description:"ترجمة الإضافة",tags:[],title:"ترجمة",uri:"/peertube-plugin-livechat/ar/contributing/translate/index.html"},{breadcrumb:"Peertube livechat > المستندات",content:` معلومات Before updating to a major release, please read the release notes and breaking changes list : CHANGELOG.
بقشيش To install or update the plugin, just use the Peertube web admin interface.
Here are some other more specific instructions:
في حال مشكلةSome classic mistakes and workarounds.
Known issues: CPU CompatibilityFor now, the plugin only works out of the box for x86_64 and arm64 CPU architecture. Here are some instructions for other CPU architectures.
Upgrade from version older than 6.0.0Important notes when upgrading for an older version.`,description:"Plugin peertube-plugin-livechat installation guide",tags:[],title:"دليل التثبيت",uri:"/peertube-plugin-livechat/ar/documentation/installation/index.html"},{breadcrumb:"Peertube livechat > المستندات > مستندات الإدارة",content:` معلومات This feature comes with the livechat plugin version 11.0.0. You can enable mod_firewall on your Prosody server.
Doing so, Peertube admins will be able to define advanced firewall rules.
تحذير These rules could be used to run arbitrary code on the server. If you are a hosting provider, and you don’t want to allow Peertube admins to write such rules, you can disable the online editing by creating a disable_mod_firewall_editing file in the plugin directory (plugins/data/peertube-plugin-livechat/disable_mod_firewall_editing). This is opt-out, as Peertube admins can already run arbitrary code just by installing any plugin. You can still use mod_firewall by editing files directly on the server.
تعديل القواعد First, you must enable the feature in the plugin settings.
...
Send every X minutes The bot will post the message every X minutes.`,description:"The bot can send periodically some messages.",tags:[],title:"Timers",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/bot/quotes/index.html"},{breadcrumb:"Peertube livechat > المستندات > مستندات الإدارة > استخدام متقدم",content:`This chat module is based on the XMPP protocol, also known as Jabber. It is therefore possible to connect to the chats using XMPP client software. This can for example be useful to facilitate moderation operations.
For the user documentation associated with these features, please refer to the user documentation page.
معلومات Enabling these features requires configuration changes on the server, and on the DNS records. It is not possible to configure this only from the Peertube interface, and it requires some basic system some basic system admin skills.
Login to your Peertube account تحذير This feature is not yet available, and will come in a future version of the plugin.
...
إعدادات الملحق Start by going to the livechat plugin settings of your instance, then enable the setting “Enable connection to room using external XMPP accounts”. By checking this setting, new settings appear below.
...
استخدام شهادات موثوق فيها The self-signed certificates that this plugin uses by default can be rejected by some XMPP servers, for security reasons.
...
docker-compose exec -u peertube \\ peertube \\ /data/plugins/data/peertube-plugin-livechat/prosodyAppImage/squashfs-root/AppRun \\ prosodyctl \\ --config /data/plugins/data/peertube-plugin-livechat/prosody/prosody.cfg.lua \\ check certsفي حال مشكلة If you can’t make it work, you can use the diagnostic tool (there is a button on top of the plugin settings page), and take a close look on the «Prosody check» section.`,description:"Allow connections using XMPP clients",tags:[],title:"XMPP clients",uri:"/peertube-plugin-livechat/ar/documentation/admin/advanced/xmpp_clients/index.html"},{breadcrumb:"Peertube livechat > المساهمة",content:"You don’t need to know how to code to start contributing to this plugin! Other contributions are very valuable too, among which: you can test the software and report bugs, you can give feedback, features that you are interested in, user interface, design, …",description:"عبّر عن رأيك",tags:[],title:"عبّر عن رأيك",uri:"/peertube-plugin-livechat/ar/contributing/feedback/index.html"},{breadcrumb:"Peertube livechat > المستندات",content:` الإعداداتPlugin Peertube Livechat settings
استيثاق خارجيPlugin Peertube Livechat settings - External Authentication
Prosody mod_firewallAdvanced firewall rules for the Prosody server
استخدام متقدمبعض الميزات المتقدمة
XMPP clientsAllow connections using XMPP clients
استخدم MatterbridgeUsing Matterbridge to bridge with other chats`,description:"Plugin Peertube Livechat administration",tags:[],title:"مستندات الإدارة",uri:"/peertube-plugin-livechat/ar/documentation/admin/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم",content:`OBS is a popular Free And Open Source streaming software, with advanced capacities for your live streams. In the current page, you will find some advices to handle your live chats using OBS.
OBS Overlay You can easily include the chat in your video stream.
You can use the “مشاركة رابط قناة الدردشة” feature to generate an URL to your chat. This button should be near the chat if you are the video owner (unless it was desactivated by your server admins).
Check the “قراءة فقط” checkbox in the modal.
...
OBS Dock معلومات This feature comes with the livechat plugin version 10.1.0. تحذير This feature can be disabled by the instance’s adminitrators.
...
To do so, just use the “مشاركة رابط قناة الدردشة” feature, and open the “Dock” tab. From there, you can create a new token using the “+” button.
...
بقشيش Tokens are valid to join any chat room. You don’t have to generate separate tokens for each of your rooms. You can also customize the nickame that will be used by changing the n parameter in the url.
...
معلومات These tokens can be used for other purposes, as connecting to your account with XMPP bots or clients. This feature is not documented yet, and not officially supported. So use with care.
Mixing multiple chats in your live stream You can use the social_stream browser extension to mix multiple chat source (from Peertube, Twitch, Youtube, Facebook, …) and include their contents in your live stream. The compatibility with this plugin was added in recent versions.`,description:"Documentation to stream the chat content using OBS.",tags:[],title:"OBS",uri:"/peertube-plugin-livechat/ar/documentation/user/obs/index.html"},{breadcrumb:"Peertube livechat > المستندات > مستندات الإدارة",content:` XMPP clientsAllow connections using XMPP clients
استخدم MatterbridgeUsing Matterbridge to bridge with other chats`,description:"بعض الميزات المتقدمة",tags:[],title:"استخدام متقدم",uri:"/peertube-plugin-livechat/ar/documentation/admin/advanced/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر > روبوت محادثة",content:`You can configure the bot to respond to commands. A command is a message starting with a “!”, like for example “!help” that calls the “help” command.
You can setup several commands.
سطر الأمر The command, without the starting “!”. For example “help”, “sponsor”, …
رسالة The message to send.`,description:"The bot can respond to several commands.",tags:[],title:"الأوامر",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/bot/commands/index.html"},{breadcrumb:"Peertube livechat > المساهمة",content:`Always talk about features you want to develop by creating/finding and commenting the issue tackling your problem before you start working on it, and inform the community that you begin coding by claiming the issue.
Pull Request must be done on the main branch.
ملاحظه Until march 2023, contribution were made on the develop branch. This procedure is now deprecated.
Prerequisite for building this plugin It is highly recommended to be familiar with following concepts:
جيت NodeJS NPM Typescript To build the plugin, you must have following packages:
...
التطوير Clone the repository, buid the plugin, and create your feature branch:
...
تحذير Don’t enable this mode on a production server, neither on a public server. This could cause security issues.
إعادة تشغيل Prosody When debug mode is enabled, you can restart Prosody using this API call: http://your_instance.tld/plugins/livechat/router/api/restart_prosody. This call don’t need any authentificaiton. It can be done from a command line, for example using curl http://your_instance.tld/plugins/livechat/router/api/restart_prosody.
...
re-build necessary parts of the plugin (client, styles, …), overwrite the data/plugins/node_modules/peertube-plugin-livechat/dist/ content of your dev instance by the content of the plugin’s dist folder, change recursively plugins/node_modules/peertube-plugin-livechat/dist/ files owner to your peertube user, restart your instance. Performance tests The livechat-perf-test repository contains some tools to make performance tests. It can be used to evaluate code improvements, or find bottlenecks.`,description:"التطوير",tags:[],title:"التطوير",uri:"/peertube-plugin-livechat/ar/contributing/develop/index.html"},{breadcrumb:"Peertube livechat > Technical documentation",content:`The livechat plugin stores some data on the server, in the /var/www/peertube/storage/plugins/data/peertube-plugin-livechat/ folder. This page describes these data.
...
ضبط Matterbridge In the version 1.22.4, Matterbridge added support for XMPP anonymous connections needed to connect to the built-in prosody.
...
معلومات This documentation use an anonymous account to connect the bridge to the chat. But since the livechat v10.1.0, there is a new way to generate long term authentication token, that allows to connect using your account. This is used for OBS docks. Using this feature for other purposes is not documented and not officially supported yet. If you want to use it anyway, you can request a token by calling then /plugins/livechat/router/api/auth/tokens endpoint. To get needed headers and request body, just check what happens when you generate a new token for OBS docks.`,description:"Using Matterbridge to bridge with other chats",tags:[],title:"استخدم Matterbridge",uri:"/peertube-plugin-livechat/ar/documentation/admin/advanced/matterbridge/index.html"},{breadcrumb:"Peertube livechat > المساهمة",content:`معلومات عامة Always inform the community before working (by creating a new issue, or commenting an existing one). This is to avoid that two persons are working on the same thing, and prevent conflicts.
...
الترجمات اللغة الرئيسية هي الإنجليزية (رمز en).
...
إضافة لغة جديدة In the support/documentation/config.toml file, please copy and modify the [Languages.fr] section.
If the translations are not complete, it does not matter, english will be used for missing strings.
معاينة To preview your modifications, just run:
...
تحذير Some linux distro (like Debian Bullseye for example) have too old version of po4a. Please make sure to install a compatible version. If you are using Debian Bullseye for example, you can download the Bookworm po4a.deb file from https://packages.debian.org, and install it manually.
...
كتابة الدليل Just edit the english files in support/documentation/content/en.
...
تحذير There may be links to this documentation elsewhere on the web. Try not to change the urls of the documentation pages. Or at the very least, put links to the new location on the previous url.
...
معلومات This feature comes with the livechat plugin version 12.0.0. What if I can’t use hugo and/or po4a? Just edit english markdown files, and specify that you can’t build translations when you make your Pull Request.
النشر Publishing the documentation is automatic, as soon as the changes are merged into the documentation branch.`,description:"Document the plugin, or translate the documentation.",tags:[],title:"المستندات",uri:"/peertube-plugin-livechat/ar/contributing/document/index.html"},{breadcrumb:"Peertube livechat > Technical documentation",content:`The livechat plugin includes a “slow mode” feature, to rate limit the number of messages that a user can send to a given MUC room. At time of writing, there were no XEP to describe such feature. Please find below a XEP draft, that will be submitted for review.
تحذير Work In Progress, this page is not done yet. For an updated version of this document, you can check the draft XEP XMP file.
...
Appendix F: Requirements Conformance The following requirements keywords as used in this document are to be interpreted as described in RFC 2119: “MUST”, “SHALL”, “REQUIRED”; “MUST NOT”, “SHALL NOT”; “SHOULD”, “RECOMMENDED”; “SHOULD NOT”, “NOT RECOMMENDED”; “MAY”, “OPTIONAL”.`,description:"MUC Slow mode XEP",tags:[],title:"MUC Slow mode",uri:"/peertube-plugin-livechat/ar/technical/slow_mode/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم",content:`This chat plugin relies on the XMPP protocol (also known as Jabber). It is therefore possible to connect to the chats using XMPP client software. This can be useful for example to facilitate moderation operations.
معلومات The features described on this page must be enabled and configured by your Peertube instance’s administrators. You may therefore not have access to them.
Login to your Peertube account تحذير This feature is not yet available, and will come in a future version of the plugin.
...
معلومات By default, the share button is only visible to the owner of the video, and the admins/moderators of the instance. However, admins can decide to display this button for everyone.
Then, choose “للاتصال عبر XMPP”:
Then you just have to click on “open” or copy/paste the address of the chat room into your XMPP client (using the “join a room” feature).`,description:"Connect to chat using a XMPP client",tags:[],title:"XMPP Clients",uri:"/peertube-plugin-livechat/ar/documentation/user/xmpp_clients/index.html"},{breadcrumb:"Peertube livechat",content:`Interested in contributing? Awesome!
قواعد السلوكContributor Covenant Code of Conduct
ترجمةترجمة الإضافة
عبّر عن رأيكعبّر عن رأيك
التطويرالتطوير
المستنداتDocument the plugin, or translate the documentation.`,description:"المساهمة",tags:[],title:"المساهمة",uri:"/peertube-plugin-livechat/ar/contributing/index.html"},{breadcrumb:"Peertube livechat > Technical documentation",content:`You can set terms & conditions on the instance level (called “global terms”), or at the streamers’ channels level (called “muc terms”, as it is related to muc rooms).
...
As the backend does no localization, it also translate on the fly the english sentences coming from the backend (in the form definition, in poll start/end message, and in bounce/error messages).`,description:"Polls technical documentation",tags:[],title:"استطلاعات الرأي",uri:"/peertube-plugin-livechat/ar/technical/polls/index.html"},{breadcrumb:"Peertube livechat > Technical documentation",content:`The livechat plugin includes a Task Application. The present document describes how this is implemented.
...
And thanks to all individual contributors who have made a donation via my liberapay page.`,description:"Plugin Credits",tags:[],title:"المُساهِمون في المشروع",uri:"/peertube-plugin-livechat/ar/credits/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر",content:`Enabling the chat for you live streams تحذير Instance administrators can choose to disable or enable chat in specific cases. Information in this section are only true in the default case.
When you create or modify a Peertube live, there is a “plugin settings” tab:
In the “plugin settings” tab, there is a “تفعيل قناة المحادثة” checkbox. Just check or uncheck it to enable or disable the chat associated to your video.
بقشيش There can be other settings in this tab, depending on plugins installed on your Peertube instance.
...
إعادة نشر المحادثة On top of the chat, there is a “مشاركة رابط قناة الدردشة” button.
This button opens a popup, where you can obtain an url to join the chat. This url can be shared.
The “الإدماج” tab provide some links to embed the chat in websites, or in your live stream.
You can customize some options:
قراءة فقط: you will only be able to read the chat, not write. This is useful to include the chat content in your live stream (see the OBS documentation). استخدم ألوان الحلة الحالية: if checked, your current theme colors will be added to the url, so that any user that opens the link will have the same color set. Generate an iframe to embed the chat in a website: instead of an url, you will obtain an HTML snippet that you can add to your website to embed the chat. For more information on the “Dock” tab, check the OBS documentation.
In the “الويب” tab, the provided url opens the chat in the Peertube interface. You can share this link to other users to invite them to join the chat.
The “مشاركة رابط قناة الدردشة” popup can also contain a “للاتصال عبر XMPP” tab. This will only be available if your instance’s administators have enabled an correctly configured this option. Using this option, you can provide a link to join the chat using any XMPP client software. Using such softwares can for example facilitate moderation actions.
الإشراف Please refer to the moderation documentation.
...
The chat will be automatically recreated each time someone tries to join it as long as the video exists, and has the “تفعيل قناة المحادثة” feature activated.`,description:"Some basics about how to setup and use the chat for your live stream",tags:[],title:"بعض الأساسيات",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/basics/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر",content:` معلومات This feature comes with the livechat plugin version 8.0.0, and can be disabled by your instance’s admins.
In the Peertube left menu, there is a “غرف المحادثات” entry:
This “غرف المحادثات” link takes you to a list of your channels. By clicking on a channel, you will then be able to setup some options for your channels:
...
بقشيش The video owner will be owner of the chat room. This means they can configure the room, delete it, promote other users as admins, …
بقشيش Starting with livechat v10.0.0, Peertube instance’s admins and moderators have no special rights on rooms by default. However, they have a special button available on top of the chat: “Become moderator”. Clicking this button will give them owner access on the room.
...
Mute anonymous users معلومات This feature comes with the livechat plugin version 10.2.0. You can prevent anonymous users to send messages. In such case, only registered users will be able to talk in the chat.
...
تحذير This section is still incomplete.
You can promote users as moderators, if you need some help.
Anonymize moderation actions معلومات This feature comes with the livechat plugin version 11.0.0. It is possible to anonymize moderation actions, to avoid disclosing who is banning/kicking/… occupants.
...
You can choose to enable or disable this feature for new chatrooms on the channel configuration page.
Participant message history search معلومات This feature comes with the livechat plugin version 11.0.0. As a room admin or owner, you can search all messages sent by a given participant.
To do so, you have several ways:
using the “البحث عن كل الرسائل” action in the dropdown menu besides participants in the sidebar using the “البحث عن كل الرسائل” action in the dropdown menu besides chat messages بقشيش To have more space and better readability, open the chat in full-page mode.
...
الإشراف على الخادم As Peertube instance moderator or administrator, you will probably need to check that your users are not behaving badly.
You can list all existing chatrooms: in the plugin settings screen, there is a button «List rooms».
From there, you can also promote yourself as room moderator by using the “Become moderator” button on the right.`,description:"Plugin peertube-plugin-livechat advanced moderation features",tags:[],title:"الإشراف",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/moderation/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر",content:` معلومات This feature comes with the livechat plugin version 10.2.0. الضبط You can add terms & conditions to your channel. These terms will be shown to all users joining the chat.
...
مشاهدون When joining the chat, viewers will see the terms:
معلومات Peertube instance’s admin can also set global terms & conditions. If so, these terms will be shown above your channel’s terms.
معلومات Anonymous users will only see the terms & conditions once they have chosen their nickname (in other words: once they are able to talk).
...
ميزة الوضع البطيء On the channel configuration page, you can set the slow mode option:
...
This limitation does not apply to moderators.`,description:"Plugin peertube-plugin-livechat slow mode",tags:[],title:"الوضع البطيء",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/slow_mode/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر",content:` معلومات This feature comes with the livechat plugin version 10.3.0. مقدمة As a streamer, you can choose to delay messages in the chat, to let some time to moderators to delete messages before they can even be read by other participants.
...
بقشيش You can combine a short moderation delay (1 second for example) with the moderation bot to delete messages containing swear words before any non-moderator user will see them.
In the chat As a moderator, you will see the remaining time (in seconds) before the message is broadcasted, just besides the message datetime.`,description:"Plugin peertube-plugin-livechat moderation delay",tags:[],title:"Moderation delay",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/moderation_delay/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر",content:` معلومات This feature comes with the livechat plugin version 10.1.0. الوجوه التعبيرية الخاصة بالقناة Streamers can add custom emojis to their channels.
...
[ { "sn": ":short_name:", "url": "https://example.com/image.png" } ] The sn attribute is the short name code. The url attribute can be any image url than your browser can access, or a Data URL representing the file you want to import.`,description:"Plugin peertube-plugin-livechat custom emojis",tags:[],title:"الإيموجي المخصصة",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/emojis/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر",content:` معلومات This feature comes with the livechat plugin version 12.0.0. Emojis only mode You can enable an “Emojy only mode” in your chatrooms. When this mode is enabled, participants can only send emojis (standard, or channel custom emojis). Moderators are not affected by this limitation.
...
“سؤال”: the question to ask to you viewers “Poll duration (in minutes)”: the duration for which viewers can vote “Anonymous results”: if checked, votes won’t be publicly visible in the chat “Choice N”: choices that will be presented to viewers You must at least fill the two first choices fields.
...
صلاحيات الوصول Every room’s admins can create a new poll.
...
بقشيش Anonymous viewers can only vote once they have choosen their nickname.
...
بقشيش To have more space and better readability, open the chat in full-page mode.
صلاحيات الوصول Every room’s admins have access to the Task Application (read and write access).
...
قائمة المهام By default, there is one task list that has the same name as your livestream.
...
بقشيش All modification are instantly visible in all your browser tabs, and for all room’s admins.
المهام إنشاء مهام You can create a task using the button on the right of task lists. This opens a form with two fields: a mandatory task name, and an optional description.
تعديل المهام Tasks can be edited by using the edit button on the right.
...
Using this feature, for example, you can ask your moderators to highlight all chat questions, so you can see them at a glance during your livestream, and check them as answered.`,description:"You can handle tasks and task lists with your moderation team.",tags:[],title:"Tasks / To-do lists",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/tasks/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر",content:` معلومات This feature comes with the livechat plugin version 11.0.0. مقدمة The livechat plugin includes a Moderator Notes Application: you can write some notes, that could be associated to chat participants. Every room’s admins have access to these notes, so they can edit them collaboratively.
You can for example use this Application to:
share some notes between moderators take notes about participants that were kicked or caused troubles … Using the Moderator Notes Application Opening the Moderator Notes Application To open the Moderator Notes Application, there is a “ملاحظات الإشراف” button in the top chat menu:
Clicking this button will toggle the Application display:
بقشيش To have more space and better readability, open the chat in full-page mode.
صلاحيات الوصول Every room’s admins have access to this Application (read and write access).
...
النطاق Notes are only available in the room in which you have created them.
...
تحذير Currently the video vs channel rooms is an instance-wide settings. Only Peertube admins can change it, and it applies to all chatrooms. In the future, this choice will be added in your channel’s options.
الملاحظات Create/Edit Notes You can use the plus button on the top to create a new note. You can also edit existing notes using the edit button, or delate any note.
بقشيش All modification are instantly visible in all your browser tabs, and for all room’s admins.
...
click on the “البحث عن ملاحظة” button that is available on notes to find all notes related to the same participant click on the “البحث عن ملاحظة” button in the dropdown menu besides participants in the sidebar click on the “البحث عن ملاحظة” button in the dropdown menu besides chat messages You can remove the filter by clicking on the close button.
...
ترتيب الملاحظات You can sort notes simply using drag & drop.`,description:"Plugin peertube-plugin-livechat moderation notes",tags:[],title:"ملاحظات الإشراف",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/moderation_notes/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر",content:` معلومات This feature comes with the livechat plugin version 8.0.0, and can be disabled by your instance’s admins.
...
المصطلحات الممنوعةThe bot can automatically moderate messages containing forbidden words.
TimersThe bot can send periodically some messages.
الأوامرThe bot can respond to several commands.
The bot will reload instantly when you save the page.`,description:"ضبط روبوت المحادثة",tags:[],title:"روبوت محادثة",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/bot/index.html"},{breadcrumb:"Peertube livechat",content:"",description:"",tags:[],title:"فئات",uri:"/peertube-plugin-livechat/ar/categories/index.html"},{breadcrumb:"",content:` بقشيش You can use the language selector in the left menu to view this documentation in different languages. Some translations are missing or incomplete. In this case, you’ll see the English version of the text.
...
بقشيش You can use the searchbox in the left menu to quickly find specific documentation parts.
معلومات Before updating to a major release, please read the release notes and breaking changes list : CHANGELOG.
مقدمةمقدمة
المستنداتمستندات الملحق
دليل المستخدمPlugin peertube-plugin-livechat user documentation
For viewersHow to chat for stream viewers
OBSDocumentation to stream the chat content using OBS.
XMPP ClientsConnect to chat using a XMPP client
للناشرين على المباشرHow to setup the chat for your live stream
...
استخدام متقدمبعض الميزات المتقدمة
XMPP clientsAllow connections using XMPP clients
استخدم MatterbridgeUsing Matterbridge to bridge with other chats
المساهمةالمساهمة
قواعد السلوكContributor Covenant Code of Conduct
ترجمةترجمة الإضافة
عبّر عن رأيكعبّر عن رأيك
التطويرالتطوير
المستنداتDocument the plugin, or translate the documentation.
متعقّب الأخطاء والميزات الجديدةمتعقّب الأخطاء \\ طلبات الميزات الجديدة
...
الاتصال بيالاتصال بالمؤلف
المُساهِمون في المشروعPlugin Credits`,description:"Peertube plugin livechat documentation",tags:[],title:"Peertube livechat",uri:"/peertube-plugin-livechat/ar/index.html"},{breadcrumb:"Peertube livechat",content:"",description:"",tags:[],title:"الكلمات الدالة",uri:"/peertube-plugin-livechat/ar/tags/index.html"}]