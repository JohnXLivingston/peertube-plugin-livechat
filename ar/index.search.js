...
If you have a Peertube account on another Peertube instance معلومات This feature comes with the livechat plugin version 9.0.0.
...
Peertube theme: this is a special theme, made especially for peertube’s integration. Default ConverseJS theme: this is the default ConverseJS theme. ConverseJS cyberpunk theme: this is a theme provided by ConverseJS. استكشاف تلقائي للألوان Try to autodetect colors from user’s current theme. When this setting is enabled, the plugin tries to auto-detect colors to apply to the chat theme. If this is not correctly working for some of your Peertube theme, you can disable this option. You can report the bug on the official issue tracker . Don’t forget to specify which theme is not working.
...
منفذ Prosody The port that will be used by the Prosody server. Change it if this port is already in use on your server. You can close this port on your firewall, it will not be accessed from the outer world. Note: this might change in a near future, as it is planned to add a feature to activate external connections.
Peertube url for API calls Please let this setting empty if you don’t know what you are doing. In some rare cases, Prosody can’t call Peertube’s API from its public URI. You can use this field to customize Peertube’s URI for Prosody modules (for example, with «http://localhost:9000» or «http://127.0.0.1:9000»).
...
Enable connection to room using external XMPP accounts By enabling this option, it will be possible to connect to rooms using external XMPP accounts and XMPP clients. Warning, enabling this option can request extra server and DNS configuration. Please refer to the documentation: Enable external XMPP account connections. منفذ Prosody مِن خادم إلى خادم آخر The port that will be used for XMPP s2s (server to server) connections. You should use the standard 5269 port. Otherwise you should setup a specific DNS record .
...
المكونات الخارجية The external components to declare:
...
Send every X minutes The bot will post the message every X minutes.`,description:"The bot can send periodically some messages.",tags:[],title:"Timers",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/bot/quotes/index.html"},{breadcrumb:"Peertube livechat > المساهمة",content:`You can contribute to this plugin translation. Translations are handled using the Weblate software, using Framasoft Weblate instance.
...
OBS Dock معلومات This feature comes with the livechat plugin version 10.1.0.
تحذير This feature can be disabled by the instance’s adminitrators.
...
Mute anonymous users معلومات This feature comes with the livechat plugin version 10.2.0.
...
Anonymize moderation actions معلومات This feature comes with the livechat plugin version 11.0.0.
...
You can choose to enable or disable this feature for new chatrooms on the channel configuration page.
Participant message history search معلومات This feature comes with the livechat plugin version 11.0.0.
...
From there, you can also promote yourself as room moderator by using the “Become moderator” button on the right.`,description:"Plugin peertube-plugin-livechat advanced moderation features",tags:[],title:"الإشراف",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/moderation/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر",content:` معلومات This feature comes with the livechat plugin version 10.2.0.
الضبط You can add terms & conditions to your channel. These terms will be shown to all users joining the chat.
...
This limitation does not apply to moderators.`,description:"Plugin peertube-plugin-livechat slow mode",tags:[],title:"الوضع البطيء",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/slow_mode/index.html"},{breadcrumb:"Peertube livechat > المستندات > دليل المستخدم > للناشرين على المباشر",content:` معلومات This feature comes with the livechat plugin version 10.3.0.
مقدمة As a streamer, you can choose to delay messages in the chat, to let some time to moderators to delete messages before they can even be read by other participants.
...
مقدمة The livechat plugin includes a Moderator Notes Application: you can write some notes, that could be associated to chat participants. Every room’s admins have access to these notes, so they can edit them collaboratively.
