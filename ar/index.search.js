...
You can also change your nickname using the chat menu.`,description:"How to chat for stream viewers",tags:[],title:"For viewers",uri:"/peertube-plugin-livechat/ar/documentation/user/viewers/index.html"},{breadcrumb:"Peertube livechat > المستندات > User documentation > For streamers > Chat bot",content:`You can configure some words that will be automatically moderated by the bot (messages containing such words will be instantly deleted). You can also add an optional reason that will be displayed at the place of deleted messages. Several examples are provided on the documentation page. You can fill several “Forbidden words or expressions” fields. When a user sends a message that match the configured criteria, the message will automatically be deleted.
...
Chat behaviour نوع قناة الدردشة You can choose here to have separate rooms for each video, or to group them by channel. فتح قناة الدردشة تلقائيا When watching a video, the chatbox will automatically open. Show the «open in new window» button There will be a button for opening the web chat in a new window. Show the «share chat link» button This feature enables a «share chat link» modal. With this modal, you can generate URLs to join the chat. The chat can be customized (readonly mode, use the current theme, …).
...
تفعيل الدردشة على كافة المباشرات If checked, the chat will be enabled for all lives. Activate chat for all non-lives Activate chat for all non-lives Activate chat for these videos Activate chat for these videos Hide the chat for anonymous users If checked, anonymous Peertube users won't see the chat. This feature is still experimental. If you enabled it, it is highly recommended to also check "Don't publish chat information". Otherwise, some third party tools could try to open the chat, and have unpredictable behaviours. Note: for now this feature simply hide the chat. In a future release, the chat will be replaced by a message saying «please log in to […]». See v5.7.0 Release Notes for more information.
...
Peertube theme: this is a special theme, made especially for peertube’s integration. Default ConverseJS theme: this is the default ConverseJS theme. ConverseJS concord theme: this is a theme provided by ConverseJS. Automatic color detection Try to autodetect colors from user's current theme.
...
vendor The vendor folder is not part of the source code. It is used during the build process to download some external source code.`,description:"Source code organization",tags:[],title:"Source code",uri:"/peertube-plugin-livechat/ar/technical/sourcecode/index.html"},{breadcrumb:"Peertube livechat > المستندات > Installation guide",content:`I just installed/upgraded the plugin, but nothing happens If you have just installed/upgraded the plugin, but nothing happens (no chat, no settings, buttons in the settings page does not work, …), just try to reload the page.
...
Using MatterbridgeUsing Matterbridge to bridge with other chats`,description:"Plugin documentation",tags:[],title:"المستندات",uri:"/peertube-plugin-livechat/ar/documentation/index.html"},{breadcrumb:"Peertube livechat > المساهمة",content:` بقشيش This Code of Conduct is adapted from the Contributor Covenant, version 2.1, available at https://www.contributor-covenant.org/version/2/1/code_of_conduct.html. Translations are available at https://www.contributor-covenant.org/translations. Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement by mail at git.[at].john-livingston.fr.
...
TroubleshootingSome classic mistakes and workarounds.
Known issues: CPU CompatibilityFor now, the plugin only works out of the box for x86_64 and arm64 CPU architecture. Here are some instructions for other CPU architectures.
Upgrade from version older than 6.0.0Important notes when upgrading for an older version.`,description:"Plugin peertube-plugin-livechat installation guide",tags:[],title:"Installation guide",uri:"/peertube-plugin-livechat/ar/documentation/installation/index.html"},{breadcrumb:"Peertube livechat > المستندات > Installation guide",content:`The Prosody AppImage included in the plugin will only work on x86_64 and arm64 CPU. It is not compatible with other CPU architectures.
...
Generic recommandations Please be inclusive in your wordings, and please respect the code of coduct.`,description:"ترجمة الإضافة",tags:[],title:"ترجمة",uri:"/peertube-plugin-livechat/ar/contributing/translate/index.html"},{breadcrumb:"Peertube livechat > المستندات",content:` SettingsPlugin Peertube Livechat settings
External AuthenticationPlugin Peertube Livechat settings - External Authentication
Prosody mod_firewallAdvanced firewall rules for the Prosody server
Advanced usageSome advanced features
XMPP clientsAllow connections using XMPP clients
Using MatterbridgeUsing Matterbridge to bridge with other chats`,description:"Plugin Peertube Livechat administration",tags:[],title:"Admin documentation",uri:"/peertube-plugin-livechat/ar/documentation/admin/index.html"},{breadcrumb:"Peertube livechat > المستندات > Admin documentation",content:` معلومات This feature comes with the livechat plugin version 11.0.0.
You can enable mod_firewall on your Prosody server.
...
Examples Don’t hesitate to share your rules. To do so, you can for example edit this page.`,description:"Advanced firewall rules for the Prosody server",tags:[],title:"Prosody mod_firewall",uri:"/peertube-plugin-livechat/ar/documentation/admin/mod_firewall/index.html"},{breadcrumb:"Peertube livechat > المستندات > Admin documentation > Advanced usage",content:`This chat module is based on the XMPP protocol, also known as Jabber. It is therefore possible to connect to the chats using XMPP client software. This can for example be useful to facilitate moderation operations.
...
Appendix F: Requirements Conformance The following requirements keywords as used in this document are to be interpreted as described in RFC 2119: “MUST”, “SHALL”, “REQUIRED”; “MUST NOT”, “SHALL NOT”; “SHOULD”, “RECOMMENDED”; “SHOULD NOT”, “NOT RECOMMENDED”; “MAY”, “OPTIONAL”.`,description:"MUC Slow mode XEP",tags:[],title:"MUC Slow mode",uri:"/peertube-plugin-livechat/ar/technical/slow_mode/index.html"},{breadcrumb:"Peertube livechat > المستندات > User documentation",content:`This chat plugin relies on the XMPP protocol (also known as Jabber). It is therefore possible to connect to the chats using XMPP client software. This can be useful for example to facilitate moderation operations.
...
التطويرالتطوير
المستنداتDocument the plugin, or translate the documentation.`,description:"المساهمة",tags:[],title:"المساهمة",uri:"/peertube-plugin-livechat/ar/contributing/index.html"},{breadcrumb:"Peertube livechat > Technical documentation",content:`The poll system relies on two thinks:
...
And thanks to all individual contributors who have made a donation via my liberapay page.`,description:"Plugin Credits",tags:[],title:"Credits",uri:"/peertube-plugin-livechat/ar/credits/index.html"},{breadcrumb:"Peertube livechat > المستندات > User documentation > For streamers",content:`Enabling the chat for you live streams تحذير Instance administrators can choose to disable or enable chat in specific cases. Information in this section are only true in the default case.
...
Share the chat On top of the chat, there is a “مشاركة رابط قناة الدردشة” button.
...
The chat will be automatically recreated each time someone tries to join it as long as the video exists, and has the “تفعيل قناة المحادثة” feature activated.`,description:"Some basics about how to setup and use the chat for your live stream",tags:[],title:"Some basics",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/basics/index.html"},{breadcrumb:"Peertube livechat > المستندات > User documentation > For streamers",content:` معلومات This feature comes with the livechat plugin version 8.0.0, and can be disabled by your instance’s admins.
...
using the “Search all messages” action in the dropdown menu besides participants in the sidebar using the “Search all messages” action in the dropdown menu besides chat messages بقشيش To have more space and better readability, open the chat in full-page mode.
...
This limitation does not apply to moderators.`,description:"Plugin peertube-plugin-livechat slow mode",tags:[],title:"Slow mode",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/slow_mode/index.html"},{breadcrumb:"Peertube livechat > المستندات > User documentation > For streamers",content:` معلومات This feature comes with the livechat plugin version 10.3.0.
...
Sorting notes You can sort notes simply using drag & drop.`,description:"Plugin peertube-plugin-livechat moderation notes",tags:[],title:"Moderation notes",uri:"/peertube-plugin-livechat/ar/documentation/user/streamers/moderation_notes/index.html"},{breadcrumb:"Peertube livechat > المستندات > User documentation > For streamers",content:` معلومات This feature comes with the livechat plugin version 8.0.0, and can be disabled by your instance’s admins.
...
CreditsPlugin Credits`,description:"Peertube plugin livechat documentation",tags:[],title:"Peertube livechat",uri:"/peertube-plugin-livechat/ar/index.html"},{breadcrumb:"Peertube livechat",content:"",description:"",tags:[],title:"الكلمات الدالة",uri:"/peertube-plugin-livechat/ar/tags/index.html"}]